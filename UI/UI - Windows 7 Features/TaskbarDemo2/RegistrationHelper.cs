...
namespace TaskbarDemo
{
    class RegistrationHelper
    {
        ...
        //static RegistryKey classesRoot= Registry.ClassesRoot;

        public static void RegisterProgId(string progId, string appId,
            string openWith)
        {
        ...
        public static void UnregisterProgId(string progId)
        {
            try
            {
        ...
        public static void RegisterFileAssociation(string progId, string extension)
        {
        ...
        public static void UnregisterFileAssociation(string progId, string extension)
        {
            try
            {
                RegistryKey openWithKey = classesRoot.CreateSubKey(
