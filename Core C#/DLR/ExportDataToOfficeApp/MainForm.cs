...
namespace ExportDataToOfficeApp
{
   public partial class MainForm : Form
   {
      ...
      {
         ExportToExcel(_carsInStock);
         // ExportToExcel2008(carsInStock);
      }

      private void MainForm_Load(object sender, EventArgs e)
      {
         _carsInStock = new List<Car> 
            {
      ...
      private void btnAddNewCar_Click(object sender, EventArgs e)
      {
         ...
         {
            // Add new car to list.
            _carsInStock.Add(d.theCar);
            UpdateGrid();
         }
      }
      #endregion

      #region Экспорт в лист Export.
      static void ExportToExcel(List<Car> carsInStock)
      {
         ...
         {
            MessageBox.Show(comEx.Message, "Excel is not installed");
         }
      }
      #endregion
      ...
      private void UpdateGrid()
      {
         ...
         dataGridCars.DataSource = _carsInStock;
      }
      #endregion
   }
}
