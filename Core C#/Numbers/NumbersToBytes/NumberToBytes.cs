/**
 * Взаимные преобразования чисел в байты
 */
using System;
using System.Text;

namespace HowToCSharp.Ch05.NumbersToBytes
{
   class NumberToBytes
   {
      static void Main()
      {
         ...
         byte[] int16Bytes = BitConverter.GetBytes(val);
      ...
      static string GetByteString(byte[] bytes)
      {
         ...
         // Проход в обратном порядке, т.к. порядок little-endian
      ...
      /// <summary>
      /// Преобразование десятичного числа в массив байтов
      /// </summary>
      ...
      /// <summary>
      /// Преобразование массива байтов в десятичное число
      /// </summary>
