...
namespace CSharp7Features
{
   public class Demo
   {
      public Demo()
      {
         ...
         const string stringInt = "10s";
         Console.WriteLine(stringInt.ToInt() ? "Valid Integer" : "Invalid Integer");
         ...
         Console.WriteLine(
            $"{person.Fullname} was born on {person.BirthDate:dd MMMM yyyy} and is {person.Age} years old.");
         ...
         cylinder = new Cylinder(20, 2.5);
         sphere = new Sphere(2.5);
         pyramid = new Pyramid(2.5, 3, 16);
      ...
      private double CalculateVolume<T>(T volumeShape)
      {
         switch (volumeShape)
         {
            ...
            case Pyramid p:
               return p.BaseLength * p.BaseWidth * p.Height / 3;
            default:
               throw new ArgumentException("Unrecognized object", nameof(volumeShape));
         }
      }
      ...
      {
         string MethodTwo() => "I am local function two";

         var getText = MethodTwo();
         return getText;
      }

      private string MethodTwo() => "I am method two";
