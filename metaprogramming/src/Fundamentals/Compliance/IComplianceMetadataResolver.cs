...
{
    /// <summary>
    ///    Check whether a specific <see cref="Type" /> has any <see cref="ComplianceMetadata" /> associated with it.
    /// </summary>
    ...
    /// <summary>
    ///    Check whether a specific <see cref="PropertyInfo" /> has any <see cref="ComplianceMetadata" /> associated
    ///    with it.
    /// </summary>
