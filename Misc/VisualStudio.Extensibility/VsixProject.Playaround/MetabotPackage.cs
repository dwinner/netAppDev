//------------------------------------------------------------------------------
// <copyright file="MetabotPackage.cs" company="Company">
...
namespace VsixProject.Playaround
{
   /// <summary>
   ...
   public sealed class MetabotPackage : Package
   {
      ...
      /// </summary>
      public const string PackageGuidString = "e8a5767e-39cd-4562-a8b0-eece69fe1b46";
