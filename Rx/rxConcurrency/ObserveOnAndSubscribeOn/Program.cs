...
using ObserveOnAndSubscribeOn.Helpers;
...
internal class Program
{
   ...
   {
      Demo.DisplayHeader(
         "SubscribeOn operator - running the unsubscrition on another schdeudler might be confusing since it can take long time to complete");
   ...
   {
      Demo.DisplayHeader(
         "SubscribeOn operator - runs the observer subscription and unsubscription on the specified Scheduler");
