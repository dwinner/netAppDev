...
namespace RxTimeBasedOperators;
...
internal static class Program
{
   ...
   {
      Demo.DisplayHeader(
         "The Sample operator - samples the observable sequence every time-interval, emitting the last item in that interval");
   ...
   {
      Demo.DisplayHeader(
         "Throttle operator - only emit an item from an Observable if a particular timespan has passed without it emitting another item");
   ...
   {
      Demo.DisplayHeader(
         "Throttle operator - each element can define the throttling duration independantly by providing a function that creates an observable");
   ...
   {
      Demo.DisplayHeader(
         "Throttle operator - each notification can be shifted independently by providing observable that signals the delay is over");
