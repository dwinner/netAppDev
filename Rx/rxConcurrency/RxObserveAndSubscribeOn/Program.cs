...
namespace RxObserveAndSubscribeOn;
...
internal static class Program
{
   ...
   {
      Demo.DisplayHeader(
         "SubscribeOn operator - running the unsubscrition on another scheduler might be confusing since it can take long time to complete");
