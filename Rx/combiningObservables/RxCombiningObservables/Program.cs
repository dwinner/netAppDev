...
namespace RxCombiningObservables;
...
internal static class Program
{
   ...
   {
      Demo.DisplayHeader(
         "The Merge operator - you can controll the amount of concurrent subscription made by Merge ");
   ...
   private static void MergingObservableOfObservables()
   {
      ...
      var texts = ObservableEx.FromValues("Hello", "World");
      texts
   ...
   private static void MergingTwoAsyncOperations()
   {
      ...
      var facebookMessages =
         Task.Delay(10).ContinueWith(_ => new[] { "Facebook1", "Facebook2" }); //this will finish after 10 milis
      var twitterStatuses = Task.FromResult(new[] { "Twitter1", "Twitter2" }); //this will finish immidiatly

      facebookMessages.ToObservable().Merge(twitterStatuses.ToObservable())
