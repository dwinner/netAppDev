...
namespace RxCreationalOpeartors;
         ...
         Observable.Using(
            ...
            stream =>
               Observable.Generate(
                  ...
                  reader => !reader.EndOfStream, //we continue until we reach the end of the file
                  reader => reader, //the stream is our state, it holds the position in the file 
                  reader => reader.ReadLine()) //each iteration will emit the current line (and moves to the next)
         );
