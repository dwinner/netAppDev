...
namespace EqualsAndPerformance
{
      ...
      IEquatable<ComplexNumber>
   {
      ...
      public override int GetHashCode() => (int)Magnitude;

      public static bool operator ==(ComplexNumber num1, ComplexNumber num2) => num1.Equals(num2);

      public static bool operator !=(ComplexNumber num1, ComplexNumber num2) => !(num1 == num2);

      public int CompareTo(ComplexNumber other) => Equals(other) ? 0 : Magnitude > other.Magnitude ? 1 : -1;
      ...
      public double Magnitude => Math.Sqrt(Math.Pow(_real, 2) + Math.Pow(_imaginary, 2));
   }
}