...
namespace ChainOfResponsibility
{
   internal static class Program
   {
      ...
      private static IProjectItem CreateData()
      {
         ...
         IProjectItem task1 =
            new ProjectTask(project, "Fortune", "Acquire a personal island paradise", contact4, true);
         ...
         IProjectItem task9 =
            new ProjectTask(task3, "Name1", "Research every possible name in the world", null, true);
      ...
      private static void GetItemInfo(IProjectItem item)
      {
         ...
         {
            using (var itemEnumerator = item.ProjectItems.GetEnumerator())
            {
