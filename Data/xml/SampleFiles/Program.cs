...
{
   File.WriteAllText("contacts.xml", contacts);
}
...
{
   File.WriteAllText("customer.xml", customer);
}

const string customerCredit = """
                              <?xml version="1.0" encoding="utf-8" standalone="yes"?>
                              <customer id="123" status="archived">
                              	<firstname>Jim</firstname>
                              	<lastname>Bo</lastname>
...
if (!File.Exists("customerCredit.xml"))
{
   File.WriteAllText("customerCredit.xml", customerCredit);
}

const string customerWithCdata = """
                                 <?xml version="1.0" encoding="utf-8" ?>
...
if (!File.Exists("customerWithCDATA.xml"))
{
   File.WriteAllText("customerWithCDATA.xml", customerWithCdata);
}
...
{
   File.WriteAllText("customers.xml", customers);
}
...
{
   File.WriteAllText("logfile.xml", logfile);
}

const string customersSchema = """
                               <?xml version="1.0" encoding="utf-8"?>
...
if (!File.Exists("customers.xsd"))
{
   File.WriteAllText("customers.xsd", customersSchema);
}

const string customerXslt = """
                            <?xml version="1.0" encoding="UTF-8"?>
...
if (!File.Exists("customer.xslt"))
{
   File.WriteAllText("customer.xslt", customerXslt);
}