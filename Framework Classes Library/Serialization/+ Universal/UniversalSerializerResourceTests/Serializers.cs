...
namespace UniversalSerializerResourceTests
{
   ...
   public class UniversalSerializerSerializer : Serializer
   {
      ...
      public long SerializeThenDeserialize_Once_InRAM(object data, DataDescriptor dataDescriptor)
      {
         ...
         {
            var ser = new UniversalSerializerLib3.UniversalSerializer(new Parameters() { Stream = stream });
            ser.Serialize(data);
      ...
      {
         using (var ser = new UniversalSerializerLib3.UniversalSerializer(FileName))
         {
            ser.Serialize(data);
            var deserializedData = ser.Deserialize();
            dataDescriptor.CheckPartialDeserializedData(data, deserializedData);
   ...
   public class UniversalSerializerAsXmlSerializer : Serializer
   {
      ...
      public long SerializeThenDeserialize_Once_InRAM(object data, DataDescriptor dataDescriptor)
      {
         using (MemoryStream stream = new MemoryStream())
         {
            var ser = new UniversalSerializerLib3.UniversalSerializer(new Parameters() { Stream = stream, SerializerFormatter = SerializerFormatters.XmlSerializationFormatter });
            ser.Serialize(data);
            var deserializedData = ser.Deserialize();
            dataDescriptor.CheckPartialDeserializedData(data, deserializedData);
            return stream.Length;
   ...
   public class UniversalSerializerAsJSONSerializer : Serializer
   {
      ...
      public long SerializeThenDeserialize_Once_InRAM(object data, DataDescriptor dataDescriptor)
      {
         using (MemoryStream stream = new MemoryStream())
         {
            var ser = new UniversalSerializerLib3.UniversalSerializer(new Parameters() { Stream = stream, SerializerFormatter = SerializerFormatters.JSONSerializationFormatter });
            ser.Serialize(data);
            var deserializedData = ser.Deserialize();
            dataDescriptor.CheckPartialDeserializedData(data, deserializedData);
            return stream.Length;
