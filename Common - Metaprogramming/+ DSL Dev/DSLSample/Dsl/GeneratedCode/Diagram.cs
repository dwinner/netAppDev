...
[module: global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1506:AvoidExcessiveClassCoupling", Scope = "type", Target = "Company.DSLSample.DSLSampleDiagram")]

namespace Company.DSLSample
{
	/// <summary>
	/// DomainClass DSLSampleDiagram
	/// Description for Company.DSLSample.DSLSampleDiagram
	/// </summary>
	[DslDesign::DisplayNameResource("Company.DSLSample.DSLSampleDiagram.DisplayName", typeof(global::Company.DSLSample.DSLSampleDomainModel), "Company.DSLSample.GeneratedCode.DomainModelResx")]
	[DslDesign::DescriptionResource("Company.DSLSample.DSLSampleDiagram.Description", typeof(global::Company.DSLSample.DSLSampleDomainModel), "Company.DSLSample.GeneratedCode.DomainModelResx")]
	[DslModeling::DomainModelOwner(typeof(global::Company.DSLSample.DSLSampleDomainModel))]
	[global::System.CLSCompliant(true)]
	[DslModeling::DomainObjectId("1e84fd9d-7526-4107-af92-678ee7ced879")]
	public partial class DSLSampleDiagram : DslDiagrams::Diagram
	{
		...
		private static global::System.ComponentModel.ToolboxItemFilterAttribute[] toolboxFilters = new global::System.ComponentModel.ToolboxItemFilterAttribute[] {
					new global::System.ComponentModel.ToolboxItemFilterAttribute(global::Company.DSLSample.DSLSampleToolboxHelperBase.ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) };
		...
		{
			if(element is global::Company.DSLSample.ExampleElement)
			{
				global::Company.DSLSample.ExampleShape newShape = new global::Company.DSLSample.ExampleShape(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::Company.DSLSample.ExampleElementReferencesTargets)
			{
				global::Company.DSLSample.ExampleConnector newShape = new global::Company.DSLSample.ExampleConnector(this.Partition);
				return newShape;
			}
		...
		protected override void InitializeShapeFields(global::System.Collections.Generic.IList<DslDiagrams::ShapeField> shapeFields)
		{
			...
			global::Company.DSLSample.ExampleShape.DecoratorsInitialized += ExampleShapeDecoratorMap.OnDecoratorsInitialized;
		}
		...
		internal static partial class ExampleShapeDecoratorMap
		{
			...
			public static void OnDecoratorsInitialized(object sender, global::System.EventArgs e)
			{
				...
				propertyInfo = new DslDiagrams::AssociatedPropertyInfo(global::Company.DSLSample.ExampleElement.NameDomainPropertyId);
		...
		private global::Company.DSLSample.ExampleRelationshipConnectAction exampleRelationshipConnectAction;
		/// <summary>
		...
		public override void OnViewMouseEnter(DslDiagrams::DiagramPointEventArgs pointArgs)
		{
			...
			if(activeView != null)
			{
				...
				if (SelectedToolboxItemSupportsFilterString(activeView, global::Company.DSLSample.DSLSampleToolboxHelper.ExampleRelationshipFilterString))
				{
					if (this.exampleRelationshipConnectAction == null)
					{
						this.exampleRelationshipConnectAction = new global::Company.DSLSample.ExampleRelationshipConnectAction(this);
		...
		/// <summary>
		/// DSLSampleDiagram domain class Id.
		/// </summary>
		public static readonly new global::System.Guid DomainClassId = new global::System.Guid(0x1e84fd9d, 0x7526, 0x4107, 0xaf, 0x92, 0x67, 0x8e, 0xe7, 0xce, 0xd8, 0x79);
		/// <summary>
		/// Constructor
		/// </summary>
		/// <param name="store">Store where new element is to be created.</param>
		/// <param name="propertyAssignments">List of domain property id/value pairs to set once the element is created.</param>
		public DSLSampleDiagram(DslModeling::Store store, params DslModeling::PropertyAssignment[] propertyAssignments)
		...
		/// <param name="propertyAssignments">List of domain property id/value pairs to set once the element is created.</param>
		public DSLSampleDiagram(DslModeling::Partition partition, params DslModeling::PropertyAssignment[] propertyAssignments)
...
namespace Company.DSLSample
{
		...
		/// </summary>
		[DslModeling::RuleOn(typeof(global::Company.DSLSample.ExampleElement), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddShapeParentExistRulePriority, InitiallyDisabled=true)]
		[DslModeling::RuleOn(typeof(global::Company.DSLSample.ExampleElementReferencesTargets), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddConnectionRulePriority, InitiallyDisabled=true)]
		internal sealed partial class FixUpDiagram : FixUpDiagramBase
		{
			...
			public override void ElementAdded(DslModeling::ElementAddedEventArgs e)
			{
				...
				if(childElement is global::Company.DSLSample.ExampleElement)
				{
					parentElement = GetParentForExampleElement((global::Company.DSLSample.ExampleElement)childElement);
				} else
				{
					parentElement = null;
				}
			...
			public static global::Company.DSLSample.ExampleModel GetParentForExampleElement( global::Company.DSLSample.ExampleElement root )
			{
				// Segments 0 and 1
				global::Company.DSLSample.ExampleModel result = root.ExampleModel;
		...
		internal sealed class ConnectorRolePlayerChanged : DslModeling::RolePlayerChangeRule
		{
			...
			public override void RolePlayerChanged(DslModeling::RolePlayerChangedEventArgs e)
			{
				...
				foreach (DslDiagrams::PresentationViewsSubject connectorLink in connectorLinks)
				{
					...
					if (linkShape != null)
					{
						global::Company.DSLSample.DSLSampleDiagram diagram = linkShape.Diagram as global::Company.DSLSample.DSLSampleDiagram;
						if (diagram != null)
						{
