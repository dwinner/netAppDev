...
namespace AppDevUnited.TaskFlowDSLSample
{
	...
	/// </remarks>
	public partial class TaskFlowDSLSampleHelpKeywordHelper : TaskFlowDSLSampleHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new TaskFlowDSLSampleHelpKeywordHelper.
		/// </summary>
		protected TaskFlowDSLSampleHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the TaskFlowDSLSampleHelpKeywordHelper.
		/// </summary>
		public static TaskFlowDSLSampleHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class TaskFlowDSLSampleHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new TaskFlowDSLSampleHelpKeywordHelperBase.
		/// </summary>
		protected TaskFlowDSLSampleHelpKeywordHelperBase()
			: base() { }
