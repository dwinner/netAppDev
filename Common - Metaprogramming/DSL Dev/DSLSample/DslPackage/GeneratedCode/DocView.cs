...
namespace Company.DSLSample
{
	...
	/// </summary>
	internal partial class DSLSampleDocView : DSLSampleDocViewBase
	{
		/// <summary>
		/// Constructs a new DSLSampleDocView.
		/// </summary>
		public DSLSampleDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DSLSampleDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new DSLSampleDocView.
		/// </summary>
		protected DSLSampleDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			DSLSampleDocDataBase docData = this.DocData as DSLSampleDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for DSLSampleDocViewBase should be an DSLSampleDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.DSLSample.DSLSampleDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.DSLSample.DSLSampleDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.DSLSample.DSLSampleToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.DSLSample.DSLSampleToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.DSLSampleDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Company.DSLSample.DSLSampleHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Company.DSLSample.DSLSampleHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.DSLSample.DSLSampleHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
