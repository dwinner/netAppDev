...
namespace Company.DSLSample
{
	...
	/// </summary>
	internal partial class DSLSampleCommandSet : DSLSampleCommandSetBase
	{
		/// <summary>
		/// Constructs a new DSLSampleCommandSet.
		/// </summary>
		public DSLSampleCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class DSLSampleCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new DSLSampleCommandSetBase.
		/// </summary>
		protected DSLSampleCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewDSLSampleExplorerCommand,
				typeof(DSLSampleEditorFactory).GUID);
		...
		{
			DSLSampleExplorerToolWindow explorer = this.DSLSampleExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected DSLSampleDocData CurrentDSLSampleDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as DSLSampleDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected DSLSampleDocView CurrentDSLSampleDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as DSLSampleDocView;
			}
		}
		...
		/// </summary>
		protected DSLSampleExplorerToolWindow DSLSampleExplorerToolWindow
		{
			get
			{
				DSLSampleExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(DSLSampleExplorerToolWindow), true) as DSLSampleExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				DSLSampleExplorerToolWindow explorerWindow = this.DSLSampleExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class DSLSampleClipboardCommandSet : DSLSampleClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new DSLSampleClipboardCommandSet.
		/// </summary>
		public DSLSampleClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class DSLSampleClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new DSLSampleClipboardCommandSetBase.
		/// </summary>
		protected DSLSampleClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
