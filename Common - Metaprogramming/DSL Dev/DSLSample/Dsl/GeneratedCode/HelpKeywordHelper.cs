...
namespace Company.DSLSample
{
	...
	/// </remarks>
	public partial class DSLSampleHelpKeywordHelper : DSLSampleHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new DSLSampleHelpKeywordHelper.
		/// </summary>
		protected DSLSampleHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the DSLSampleHelpKeywordHelper.
		/// </summary>
		public static DSLSampleHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class DSLSampleHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new DSLSampleHelpKeywordHelperBase.
		/// </summary>
		protected DSLSampleHelpKeywordHelperBase()
			: base() { }
