...
namespace ExtLibrary
{
   ...
   {
      public static Func<int, int, int, bool> Compose(this Func<int, int, int> func1,
      ...
      // Generic version
      public static Func<T, T, T, bool> GenericCompose<T>(this Func<T, T, T> func1,
         Func<T, T, bool> func2)
         where T : struct
      {
         return (x, y, z) => func2(func1(x, y), z);
