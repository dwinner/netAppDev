...
names = new List<string> { "Sam", "Jack", "Joseph" };
WriteLine("Names in uppercase:");
...
namespace CustomLibrary
{
   public static class Extensions
   {
      ...
      public static IEnumerable<TResult> Map2<TSource, TResult>(this IEnumerable<TSource> container,
         Func<TSource, TResult> f) // OK
      {
         List<TResult> output = new();
         foreach (var item in container)
         {
      ...
      public static IEnumerable<TResult> Map3<TSource, TResult>(this IEnumerable<TSource> container,
         Func<TSource, TResult> f) // OK
      {
         foreach (var item in container)
         {
