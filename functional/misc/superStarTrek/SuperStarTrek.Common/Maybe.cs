...
{
   public Error(Exception e) => ErrorMessage = e;
...
{
   public Error(Exception e) => CapturedError = e;
...
public static class MaybeExtensions
{
   ...
   public static Maybe<TToType> Bind<TFromType, TToType>(this Maybe<TFromType> @this, Func<TFromType, Maybe<TToType>> f)
   {
      switch (@this)
      {
         case Something<TFromType> sth when !EqualityComparer<TFromType>.Default.Equals(sth.Value, default):
   ...
   public static async Task<Maybe<TToType>> MapAsync<TFromType, TToType>(this Maybe<TFromType> @this,
      Func<TFromType, Task<Maybe<TToType>>> f)
   {
      switch (@this)
      {
         case Something<TFromType> sth when !EqualityComparer<TFromType>.Default.Equals(sth.Value, default):
