...
.....";
      ...
      var pipeTraverse = (Loc: grid[startLoc.X, startLoc.Y], LastMove: firstMove, length: 0).IterateUntil(
         x => x.Loc.Value == 'S',
         x => x switch
         {
...
...........";
      ...
      var pipeTraverse =
         (Loc: grid[startLoc.X, startLoc.Y], LastMove: firstMove, Trail: Enumerable.Empty<Coord>()).IterateUntil(
            x => x.Loc.Value == 'S',
            x => (x switch
            {
