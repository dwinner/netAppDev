...
public class _03_LinqDay
{
   ...
   public void Day03_Test01()
   {
      ...
      var numbers = lines.Select(
         ...
         x.Matches.Select(y => (x.Line, Number: y, xIndex: lines[x.Line].IndexOf(y, StringComparison.Ordinal))));
   ...
   public void Day03_Test02()
   {
      ...
      var overlappingNumbes =
         stars.Select(a =>
               numbers.Where(b => a.y.IsBetween(b.y - 1, b.y + 1) && a.x.IsBetween(b.x1 - 1, b.x2 + 1)).ToArray())
            .Where(x => x.Count() == 2);
   ...
   public void Day03_Part02()
   {
      ...
      var overlappingNumbes = stars.Select(a => numbers.Where(b => b.y.IsBetween(a.y - 1, a.y + 1) &&
                                                                   (b.x1.IsBetween(a.x - 1, a.x + 1) ||
                                                                    b.x2.IsBetween(a.x - 1, a.x + 1))).ToArray())
