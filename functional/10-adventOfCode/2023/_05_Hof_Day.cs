   ...
   public void Day05_Test07()
   {
      ...
      var finalRanges = reversedMaps.Aggregate(lRanges, (agg, x) =>
         agg.SelectMany(z =>
         {
            ...
            var reversedStart = xArr.SingleOrDefault(y =>
                  z.start.IsBetween(y.DestinationRangeStart, y.DestinationRangeStart + y.RangeLength - 1))
