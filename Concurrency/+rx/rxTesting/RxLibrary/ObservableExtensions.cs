...
public static class ObservableExtensions
{
   ...
   ///    a burst is a sequence of elements from an observable sequence which are followed by another element within a
   ///    specified relative time duration.
   /// </summary>
   ...
   public static IObservable<T> FilterBursts<T>(this IObservable<T> src, TimeSpan maximalDistance) =>
      src.FilterBursts(maximalDistance, DefaultScheduler.Instance);
