...
{
   [Register(nameof(ComplicationController))]
   public class ComplicationController : CLKComplicationDataSource
   {
      ...
      public override void GetPrivacyBehavior(CLKComplication complication,
         Action<CLKComplicationPrivacyBehavior> handler)
      {
      ...
      {
         Debug.WriteLine(nameof(RequestedUpdateBudgetExhausted));
      ...
      public override void GetTimelineEntriesBeforeDate(CLKComplication complication, NSDate beforeDate, nuint limit,
         Action<CLKComplicationTimelineEntry[]> handler)
      {
      ...
      public override void GetTimelineEntriesAfterDate(CLKComplication complication, NSDate afterDate, nuint limit,
         Action<CLKComplicationTimelineEntry[]> handler)
      {
      ...
      private CLKComplicationTemplate CreateComplicationTemplate(
         CLKComplicationFamily complicationFamily,
         string complicationText)
      {
         ...
         string complicationText)
      {
         ...
         return template != null ? CLKComplicationTimelineEntry.Create(NSDate.Now, template) : null;
      }
   }
}