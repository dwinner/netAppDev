...
namespace StarWarsSample.iOS.Views
{
   ...
   public class PersonView : MvxViewController<PersonViewModel>
   {
      ...
      public override void ViewDidLoad()
      {
         ...
         _viewHeight = new InfoView {Label = {Text = Strings.Height}};

         _viewMass = new InfoView {Label = {Text = Strings.Mass}};

         _viewHairColor = new InfoView {Label = {Text = Strings.HairColor}};

         _viewSkinColor = new InfoView {Label = {Text = Strings.SkinColor}};

         _viewEyeColor = new InfoView {Label = {Text = Strings.EyeColor}};

         _viewBirthYear = new InfoView {Label = {Text = Strings.BirthYear}};

         _viewGender = new InfoView {Label = {Text = Strings.Gender}};
