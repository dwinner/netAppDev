...
namespace MvvxSandboxApp.Core.ViewModels.State
{
   public class UsaStateListViewModel : BaseViewModel
   {
      ...
      public UsaStateListViewModel(IMvxNavigationService navigation, IUsaStateStorage stateStorage)
      {
         ...
         SearchStateCommand = new MvxAsyncCommand<string>(SearchState);
      }
      ...
      private Task SearchState(string searchStatePattern)
      {
         // TODO: Perform a search and restore pagination behavior
         Debug.WriteLine(searchStatePattern);
         return Task.FromResult(0);
      }
