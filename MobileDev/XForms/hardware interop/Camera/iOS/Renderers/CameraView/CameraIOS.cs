...
namespace Camera.iOS.Renderers.CameraView
{
   ...
   public sealed class CameraIOS : UIView
   {
      ...
      public CameraIOS()
      {
         ...
         AddConstraints(NSLayoutConstraint.FromVisualFormat("V:|[mainView]|",
            NSLayoutFormatOptions.DirectionLeftToRight, null, new NSDictionary("mainView", _mainView)));
         AddConstraints(NSLayoutConstraint.FromVisualFormat("H:|[mainView]|", NSLayoutFormatOptions.AlignAllTop, null,
      ...
      ///    The main view.
      /// </summary>
      private readonly UIView _mainView;
      ...
      /// </summary>
      private readonly bool _cameraAvailable;
      ...
      ///    The image scale.
      /// </summary>
      private readonly float _imgScale = 1.25f;

      /// <summary>
      ///    The system version.
      /// </summary>
      private readonly double _systemVersion;
      ...
      {
         var previewLayerFrame = _previewLayer.Frame;
      ...
      {
         var sOrientation = Orientation.None;
      ...
      private async Task CaptureImageWithMetadata(AVCaptureStillImageOutput captureStillImageOutput,
         AVCaptureConnection connection)
      {
         ...
         try
         {
            var imgData = image.AsJPEG().ToArray();
