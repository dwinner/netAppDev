...
[assembly: ExportRenderer(typeof(FocusView), typeof(FocusViewRenderer))]
...
namespace Camera.Droid.Renderers
{
   ...
   ///    Focus view renderer.
   /// </summary>
   public class FocusViewRenderer : Xamarin.Forms.Platform.Android.AppCompat.ViewRenderer<FocusView, LinearLayout>
   {
      ...
      private int ConvertPixelsToDp(float pixelValue) => (int) (pixelValue / Resources.DisplayMetrics.Density);
