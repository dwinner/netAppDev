...
namespace MasterDetailSampleApp.Controllers
{
   [Route("api/item")]
   [ApiController]
   public class ItemController : ControllerBase
   {
      ...
      public ItemController(IItemRepository itemRepository) => ItemRepository = itemRepository;

      [HttpGet]
      [ProducesResponseType(StatusCodes.Status200OK)]
      public ActionResult<IEnumerable<Item>> List() => ItemRepository.GetAll().ToList();
