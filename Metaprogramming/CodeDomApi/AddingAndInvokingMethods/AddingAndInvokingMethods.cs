...
namespace AddingAndInvokingMethods
{
   internal static class AddingAndInvokingMethods
   {
      private static void Main()
      {
         var mimsyNamespace = CreateMimsyNamespace();
      ...
      private static CodeNamespace CreateMimsyNamespace()
      {
         ...
         var jubjubClass = new CodeTypeDeclaration("Jubjub") {TypeAttributes = TypeAttributes.Public};
         var wabeCountFld = new CodeMemberField(typeof(int), "_wabeCount") {Attributes = MemberAttributes.Private};
