...
namespace AppDevUnited.TaskFlowDSLSample
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.TaskFlowDSLSampleEditorFactoryId)]
	internal partial class TaskFlowDSLSampleEditorFactory : TaskFlowDSLSampleEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new TaskFlowDSLSampleEditorFactory.
		/// </summary>
		public TaskFlowDSLSampleEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class TaskFlowDSLSampleEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected TaskFlowDSLSampleEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new TaskFlowDSLSampleDocView(docData, this.ServiceProvider);
		}
	}
}
