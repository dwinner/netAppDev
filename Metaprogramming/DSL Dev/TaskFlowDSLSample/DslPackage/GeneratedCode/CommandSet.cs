...
namespace AppDevUnited.TaskFlowDSLSample
{
	...
	/// </summary>
	internal partial class TaskFlowDSLSampleCommandSet : TaskFlowDSLSampleCommandSetBase
	{
		/// <summary>
		/// Constructs a new TaskFlowDSLSampleCommandSet.
		/// </summary>
		public TaskFlowDSLSampleCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class TaskFlowDSLSampleCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new TaskFlowDSLSampleCommandSetBase.
		/// </summary>
		protected TaskFlowDSLSampleCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewTaskFlowDSLSampleExplorerCommand,
				typeof(TaskFlowDSLSampleEditorFactory).GUID);
		...
		{
			TaskFlowDSLSampleExplorerToolWindow explorer = this.TaskFlowDSLSampleExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected TaskFlowDSLSampleDocData CurrentTaskFlowDSLSampleDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as TaskFlowDSLSampleDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected TaskFlowDSLSampleDocView CurrentTaskFlowDSLSampleDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as TaskFlowDSLSampleDocView;
			}
		}
		...
		/// </summary>
		protected TaskFlowDSLSampleExplorerToolWindow TaskFlowDSLSampleExplorerToolWindow
		{
			get
			{
				TaskFlowDSLSampleExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(TaskFlowDSLSampleExplorerToolWindow), true) as TaskFlowDSLSampleExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				TaskFlowDSLSampleExplorerToolWindow explorerWindow = this.TaskFlowDSLSampleExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class TaskFlowDSLSampleClipboardCommandSet : TaskFlowDSLSampleClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new TaskFlowDSLSampleClipboardCommandSet.
		/// </summary>
		public TaskFlowDSLSampleClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class TaskFlowDSLSampleClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new TaskFlowDSLSampleClipboardCommandSetBase.
		/// </summary>
		protected TaskFlowDSLSampleClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
