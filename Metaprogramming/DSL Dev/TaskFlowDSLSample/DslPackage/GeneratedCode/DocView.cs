...
namespace AppDevUnited.TaskFlowDSLSample
{
	...
	/// </summary>
	internal partial class TaskFlowDSLSampleDocView : TaskFlowDSLSampleDocViewBase
	{
		/// <summary>
		/// Constructs a new TaskFlowDSLSampleDocView.
		/// </summary>
		public TaskFlowDSLSampleDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class TaskFlowDSLSampleDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new TaskFlowDSLSampleDocView.
		/// </summary>
		protected TaskFlowDSLSampleDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			TaskFlowDSLSampleDocDataBase docData = this.DocData as TaskFlowDSLSampleDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for TaskFlowDSLSampleDocViewBase should be an TaskFlowDSLSampleDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::AppDevUnited.TaskFlowDSLSample.TaskFlowDSLSampleDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::AppDevUnited.TaskFlowDSLSample.TaskFlowDSLSampleDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::AppDevUnited.TaskFlowDSLSample.TaskFlowDSLSampleToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::AppDevUnited.TaskFlowDSLSample.TaskFlowDSLSampleToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.TaskFlowDSLSampleDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::AppDevUnited.TaskFlowDSLSample.TaskFlowDSLSampleHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::AppDevUnited.TaskFlowDSLSample.TaskFlowDSLSampleHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::AppDevUnited.TaskFlowDSLSample.TaskFlowDSLSampleHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
