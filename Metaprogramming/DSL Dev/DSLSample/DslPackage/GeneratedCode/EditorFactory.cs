...
namespace Company.DSLSample
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.DSLSampleEditorFactoryId)]
	internal partial class DSLSampleEditorFactory : DSLSampleEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new DSLSampleEditorFactory.
		/// </summary>
		public DSLSampleEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DSLSampleEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected DSLSampleEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new DSLSampleDocData(this.ServiceProvider, typeof(DSLSampleEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new DSLSampleDocView(docData, this.ServiceProvider);
		}
	}
}
