...
namespace Company.DSLSample
{
	...
	/// </summary>
	internal partial class DSLSampleExplorer : DSLSampleExplorerBase
	{
		/// <summary>
	...
	/// <summary>
	/// Control hosted in the DSLSampleExplorerToolWindow.
	/// </summary>
	internal abstract class DSLSampleExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.DSLSampleExplorerMenu;
			}
		}
		...
		{
			get { return global::Company.DSLSample.ExampleModel.DomainClassId; }
		}
