 ...
 */
public interface CaplParserVisitor<T> extends ParseTreeVisitor<T> {
	/**
	...
	/**
	 * Visit a parse tree produced by {@link CaplParser#decimalId}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDecimalId(CaplParser.DecimalIdContext ctx);
	/**
