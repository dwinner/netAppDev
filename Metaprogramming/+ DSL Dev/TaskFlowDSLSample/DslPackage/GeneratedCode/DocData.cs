...
namespace AppDevUnited.TaskFlowDSLSample
{
	...
	/// </summary>
	internal partial class TaskFlowDSLSampleDocData : TaskFlowDSLSampleDocDataBase
	{
		/// <summary>
		/// Constructs a new TaskFlowDSLSampleDocData.
		/// </summary>
		public TaskFlowDSLSampleDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a TaskFlowDSLSample document in memory.
	/// </summary>
	internal abstract partial class TaskFlowDSLSampleDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new TaskFlowDSLSampleDocDataBase.
		/// </summary>
		protected TaskFlowDSLSampleDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::AppDevUnited.TaskFlowDSLSample.TaskFlowDSLSampleDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::AppDevUnited.TaskFlowDSLSample.TaskFlowDSLSampleDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::AppDevUnited.TaskFlowDSLSample.TaskFlowDSLSampleDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::AppDevUnited.TaskFlowDSLSample.FlowGraph modelRoot = null;
			...
			global::AppDevUnited.TaskFlowDSLSample.TaskFlowDSLSampleDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::AppDevUnited.TaskFlowDSLSample.TaskFlowDSLSampleSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::AppDevUnited.TaskFlowDSLSample.TaskFlowDSLSampleDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::AppDevUnited.TaskFlowDSLSample.TaskFlowDSLSampleDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::AppDevUnited.TaskFlowDSLSample.FlowGraph modelRoot = (global::AppDevUnited.TaskFlowDSLSample.FlowGraph)this.RootElement;
			...
			{
				global::AppDevUnited.TaskFlowDSLSample.TaskFlowDSLSampleDiagram diagram = diagrams[0] as global::AppDevUnited.TaskFlowDSLSample.TaskFlowDSLSampleDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::AppDevUnited.TaskFlowDSLSample.TaskFlowDSLSampleSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::AppDevUnited.TaskFlowDSLSample.TaskFlowDSLSampleSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::AppDevUnited.TaskFlowDSLSample.TaskFlowDSLSampleDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::AppDevUnited.TaskFlowDSLSample.TaskFlowDSLSampleSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::AppDevUnited.TaskFlowDSLSample.FlowGraph modelRoot = this.RootElement as global::AppDevUnited.TaskFlowDSLSample.FlowGraph;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::AppDevUnited.TaskFlowDSLSample.TaskFlowDSLSampleSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
