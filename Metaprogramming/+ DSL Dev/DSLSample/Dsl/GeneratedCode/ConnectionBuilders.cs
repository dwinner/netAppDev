...
namespace Company.DSLSample
{
	...
	public static partial class ExampleElementReferencesTargetsBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::Company.DSLSample.ExampleElement)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::Company.DSLSample.ExampleElement)
				{
					if (candidateTarget is global::Company.DSLSample.ExampleElement)
					{
						global::Company.DSLSample.ExampleElement sourceExampleElement = (global::Company.DSLSample.ExampleElement)candidateSource;
						global::Company.DSLSample.ExampleElement targetExampleElement = (global::Company.DSLSample.ExampleElement)candidateTarget;
						if(targetExampleElement == null || sourceExampleElement == null || global::Company.DSLSample.ExampleElementReferencesTargets.GetLinks(sourceExampleElement, targetExampleElement).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::Company.DSLSample.ExampleElement)
				{
					if (target is global::Company.DSLSample.ExampleElement)
					{
						global::Company.DSLSample.ExampleElement sourceAccepted = (global::Company.DSLSample.ExampleElement)source;
						global::Company.DSLSample.ExampleElement targetAccepted = (global::Company.DSLSample.ExampleElement)target;
						DslModeling::ElementLink result = new global::Company.DSLSample.ExampleElementReferencesTargets(sourceAccepted, targetAccepted);
