// Расширение jQuery для увеличения изображений при просмотре
...
jQuery.imageMagnify = {
    ...
    magnify: function ($, $target, options) {
        var setting = {};
        setting = jQuery.extend (setting, this.dsettings, options);
        ...
        $target.bind ("click.magnify", function () {
            var $this = $ (this).css ({ opacity: setting.imgopacity });
            var imageinfo = $this.data ("imgshell");
            jQuery.imageMagnify.refreshoffsets ($ (window), $this, imageinfo);
            var lClone = imageinfo.$clone;
            lClone.stop().css ({ zIndex: ++jQuery.imageMagnify.zIndexcounter, left: imageinfo.attrs.x, top: imageinfo.attrs.y, width: imageinfo.attrs.w, height: imageinfo.attrs.h, opacity: 0, visibility: "visible", display: "block" })
...
jQuery.fn.applyMagnifier = function () {
    return this.each (function () {
