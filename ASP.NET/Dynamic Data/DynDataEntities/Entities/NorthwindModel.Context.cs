...
namespace DynDataEntities.Entities
{
   ...
   public partial class NorthwindEntities : DbContext
   {
      ...
      public virtual int CategoryInsert(string categoryName, string description, ObjectParameter categoryID)
      {
         ...
         return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("CategoryInsert", categoryNameParameter, descriptionParameter, categoryID);
      }
      ...
      public virtual int RegionDelete(Nullable<int> regionId)
      {
         var regionIdParameter = regionId.HasValue ?
             new ObjectParameter("RegionId", regionId) :
             new ObjectParameter("RegionId", typeof(int));

         return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("RegionDelete", regionIdParameter);
      }

      public virtual int RegionInsert(string regionDescription, ObjectParameter regionId)
      {
         ...
         return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("RegionInsert", regionDescriptionParameter, regionId);
      }

      public virtual ObjectResult<RegionSelect_Result> RegionSelect()
      {
         return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<RegionSelect_Result>("RegionSelect");
      }

      public virtual int RegionUpdate(Nullable<int> regionId, string regionDescription)
      {
         var regionIdParameter = regionId.HasValue ?
             new ObjectParameter("RegionId", regionId) :
             new ObjectParameter("RegionId", typeof(int));
         ...
         return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("RegionUpdate", regionIdParameter, regionDescriptionParameter);
      }
