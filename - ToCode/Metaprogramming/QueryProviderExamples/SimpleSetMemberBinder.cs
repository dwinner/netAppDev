...
{
    class SimpleSetMemberBinder : SetMemberBinder
    {
        private DefaultBinder defaultBinder = new DefaultBinder();

        public SimpleSetMemberBinder(string name, bool ignoreCase)
        ...
        {
            return defaultBinder.SetMember(this.Name, target, value);
        }
    }
}
