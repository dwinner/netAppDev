...
namespace Chart3DNoWPFEngine
{
   public class DrawSurfaceChart
   {
      ...
      private void AddTickLine(ChartStyle cs, Point pt1, Point pt2)
      {
         Line line = new Line();
         line.X1 = pt1.X;
         line.Y1 = pt1.Y;
      ...
      private void AddMesh(ChartStyle cs, DataSeriesSurface ds)
      {
      ...
      private void AddSurface(ChartStyle cs, DataSeriesSurface ds)
      {
         Matrix3D m = Utility.AzimuthElevation(cs.Elevation, cs.Azimuth);
         Polygon plg = new Polygon();
         Point3D[,] pts = ds.PointArray;
      ...
      private void Interp(ChartStyle cs, Matrix3D m, Point3D[] pta, double zmin, double zmax)
      {
         Polygon plg = new Polygon();
