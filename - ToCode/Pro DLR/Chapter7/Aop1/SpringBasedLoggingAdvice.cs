...
namespace Aop1
{
    public class SpringBasedLoggingAdvice : IMethodInterceptor
    {
        ...
        public void BeforeInvoke(System.Reflection.MethodInfo method, object[] args, object target)
        {
            Console.Out.WriteLine("Advice BeforeInvoke is called. Intercepted method is {0}.", method.Name);
        }

        public void AfterInvoke(object returnValue, System.Reflection.MethodInfo method, object[] args, object target)
        {
