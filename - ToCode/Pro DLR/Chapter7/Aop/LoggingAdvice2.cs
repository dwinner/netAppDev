...
public class LoggingAdvice2 : IDynamicAdvice, IMethodInterceptor
{
    ...
    {
        Console.Out.WriteLine("Advice2 BeforeInvoke is called. Intercepted method is {0}.", method.Name);
    }

    public void AfterInvoke(object returnValue, MethodInfo method, object[] args, object target)
    {
        Console.Out.WriteLine("Advice2 AfterInvoke is called. Intercepted method is {0}.", method.Name);
    }
