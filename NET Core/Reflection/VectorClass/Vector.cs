...
namespace VectorClass
{
   ...
   public class Vector : IFormattable, IEnumerable<double>
   {
      ...
      private sealed class VectorEnumerator : IEnumerator<double>
      {
         private readonly Vector _vector; // Vector object that this enumerato refers to 
         private int _location; // which element of _vector the enumerator is currently referring to 
