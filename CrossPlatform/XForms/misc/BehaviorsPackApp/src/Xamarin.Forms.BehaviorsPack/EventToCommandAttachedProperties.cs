...
namespace Xamarin.Forms.BehaviorsPack
{
   ...
   public static class Applications
   {
      ...
      public static readonly BindableProperty ModalPoppedProperty =
         BindableProperty.CreateAttached("ModalPopped", typeof(ICommand), typeof(Applications), null,
            propertyChanged: OnModalPoppedChanged);

      public static ICommand GetModalPopped(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ModalPoppedProperty);
      ...
      public static readonly BindableProperty ModalPoppingProperty =
         BindableProperty.CreateAttached("ModalPopping", typeof(ICommand), typeof(Applications), null,
            propertyChanged: OnModalPoppingChanged);

      public static ICommand GetModalPopping(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ModalPoppingProperty);
      ...
      public static readonly BindableProperty ModalPoppingNotifyCancelProperty =
         BindableProperty.CreateAttached("ModalPoppingNotifyCancel", typeof(ICommand), typeof(Applications), null,
            propertyChanged: OnModalPoppingNotifyCancelChanged);

      public static ICommand GetModalPoppingNotifyCancel(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ModalPoppingNotifyCancelProperty);
      ...
      private static void OnModalPoppingNotifyCancel(object o, ModalPoppingEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty ModalPushedProperty =
         BindableProperty.CreateAttached("ModalPushed", typeof(ICommand), typeof(Applications), null,
            propertyChanged: OnModalPushedChanged);

      public static ICommand GetModalPushed(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ModalPushedProperty);
      ...
      public static readonly BindableProperty ModalPushingProperty =
         BindableProperty.CreateAttached("ModalPushing", typeof(ICommand), typeof(Applications), null,
            propertyChanged: OnModalPushingChanged);

      public static ICommand GetModalPushing(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ModalPushingProperty);
   ...
   public static class Buttons
   {
      ...
      public static readonly BindableProperty ClickedProperty =
         BindableProperty.CreateAttached("Clicked", typeof(ICommand), typeof(Buttons), null,
            propertyChanged: OnClickedChanged);

      public static ICommand GetClicked(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ClickedProperty);
      ...
      public static readonly BindableProperty PressedProperty =
         BindableProperty.CreateAttached("Pressed", typeof(ICommand), typeof(Buttons), null,
            propertyChanged: OnPressedChanged);

      public static ICommand GetPressed(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(PressedProperty);
      ...
      public static readonly BindableProperty ReleasedProperty =
         BindableProperty.CreateAttached("Released", typeof(ICommand), typeof(Buttons), null,
            propertyChanged: OnReleasedChanged);

      public static ICommand GetReleased(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ReleasedProperty);
   ...
   public static class Cells
   {
      ...
      public static readonly BindableProperty AppearingProperty =
         BindableProperty.CreateAttached("Appearing", typeof(ICommand), typeof(Cells), null,
            propertyChanged: OnAppearingChanged);

      public static ICommand GetAppearing(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(AppearingProperty);
      ...
      public static readonly BindableProperty DisappearingProperty =
         BindableProperty.CreateAttached("Disappearing", typeof(ICommand), typeof(Cells), null,
            propertyChanged: OnDisappearingChanged);

      public static ICommand GetDisappearing(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(DisappearingProperty);
      ...
      public static readonly BindableProperty ForceUpdateSizeRequestedProperty =
         BindableProperty.CreateAttached("ForceUpdateSizeRequested", typeof(ICommand), typeof(Cells), null,
            propertyChanged: OnForceUpdateSizeRequestedChanged);

      public static ICommand GetForceUpdateSizeRequested(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ForceUpdateSizeRequestedProperty);
      ...
      public static readonly BindableProperty TappedProperty =
         BindableProperty.CreateAttached("Tapped", typeof(ICommand), typeof(Cells), null,
            propertyChanged: OnTappedChanged);

      public static ICommand GetTapped(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(TappedProperty);
   ...
   public static class ClickGestureRecognizers
   {
      #region Clicked

      public static readonly BindableProperty ClickedProperty =
         BindableProperty.CreateAttached("Clicked", typeof(ICommand), typeof(ClickGestureRecognizers), null,
            propertyChanged: OnClickedChanged);
   ...
   public static class ColumnDefinitions
   {
      ...
      public static readonly BindableProperty SizeChangedProperty =
         BindableProperty.CreateAttached("SizeChanged", typeof(ICommand), typeof(ColumnDefinitions), null,
            propertyChanged: OnSizeChangedChanged);

      public static ICommand GetSizeChanged(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(SizeChangedProperty);
   ...
   public static class DatePickers
   {
      ...
      public static readonly BindableProperty DateSelectedProperty =
         BindableProperty.CreateAttached("DateSelected", typeof(ICommand), typeof(DatePickers), null,
            propertyChanged: OnDateSelectedChanged);

      public static ICommand GetDateSelected(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(DateSelectedProperty);
      ...
      public static readonly BindableProperty DateSelectedNotifyNewDateProperty =
         BindableProperty.CreateAttached("DateSelectedNotifyNewDate", typeof(ICommand), typeof(DatePickers), null,
            propertyChanged: OnDateSelectedNotifyNewDateChanged);

      public static ICommand GetDateSelectedNotifyNewDate(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(DateSelectedNotifyNewDateProperty);
      ...
      private static void OnDateSelectedNotifyNewDate(object o, DateChangedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty DateSelectedNotifyOldDateProperty =
         BindableProperty.CreateAttached("DateSelectedNotifyOldDate", typeof(ICommand), typeof(DatePickers), null,
            propertyChanged: OnDateSelectedNotifyOldDateChanged);

      public static ICommand GetDateSelectedNotifyOldDate(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(DateSelectedNotifyOldDateProperty);
      ...
      private static void OnDateSelectedNotifyOldDate(object o, DateChangedEventArgs eventArgs)
      {
   ...
   public static class Editors
   {
      ...
      public static readonly BindableProperty CompletedProperty =
         BindableProperty.CreateAttached("Completed", typeof(ICommand), typeof(Editors), null,
            propertyChanged: OnCompletedChanged);

      public static ICommand GetCompleted(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(CompletedProperty);
      ...
      public static readonly BindableProperty TextChangedProperty =
         BindableProperty.CreateAttached("TextChanged", typeof(ICommand), typeof(Editors), null,
            propertyChanged: OnTextChangedChanged);

      public static ICommand GetTextChanged(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(TextChangedProperty);
      ...
      public static readonly BindableProperty TextChangedNotifyNewTextValueProperty =
         BindableProperty.CreateAttached("TextChangedNotifyNewTextValue", typeof(ICommand), typeof(Editors), null,
            propertyChanged: OnTextChangedNotifyNewTextValueChanged);

      public static ICommand GetTextChangedNotifyNewTextValue(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(TextChangedNotifyNewTextValueProperty);

      private static void OnTextChangedNotifyNewTextValueChanged(BindableObject bindable, object oldValue,
         object newValue)
      {
         if (bindable is Editor target)
         {
      ...
      private static void OnTextChangedNotifyNewTextValue(object o, TextChangedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty TextChangedNotifyOldTextValueProperty =
         BindableProperty.CreateAttached("TextChangedNotifyOldTextValue", typeof(ICommand), typeof(Editors), null,
            propertyChanged: OnTextChangedNotifyOldTextValueChanged);

      public static ICommand GetTextChangedNotifyOldTextValue(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(TextChangedNotifyOldTextValueProperty);

      private static void OnTextChangedNotifyOldTextValueChanged(BindableObject bindable, object oldValue,
         object newValue)
      {
         if (bindable is Editor target)
         {
      ...
      private static void OnTextChangedNotifyOldTextValue(object o, TextChangedEventArgs eventArgs)
      {
   ...
   public static class Elements
   {
      ...
      public static readonly BindableProperty ChildAddedProperty =
         BindableProperty.CreateAttached("ChildAdded", typeof(ICommand), typeof(Elements), null,
            propertyChanged: OnChildAddedChanged);

      public static ICommand GetChildAdded(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ChildAddedProperty);
      ...
      public static readonly BindableProperty ChildRemovedProperty =
         BindableProperty.CreateAttached("ChildRemoved", typeof(ICommand), typeof(Elements), null,
            propertyChanged: OnChildRemovedChanged);

      public static ICommand GetChildRemoved(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ChildRemovedProperty);
      ...
      public static readonly BindableProperty DescendantAddedProperty =
         BindableProperty.CreateAttached("DescendantAdded", typeof(ICommand), typeof(Elements), null,
            propertyChanged: OnDescendantAddedChanged);

      public static ICommand GetDescendantAdded(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(DescendantAddedProperty);
      ...
      public static readonly BindableProperty DescendantRemovedProperty =
         BindableProperty.CreateAttached("DescendantRemoved", typeof(ICommand), typeof(Elements), null,
            propertyChanged: OnDescendantRemovedChanged);

      public static ICommand GetDescendantRemoved(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(DescendantRemovedProperty);
      ...
      public static readonly BindableProperty PlatformSetProperty =
         BindableProperty.CreateAttached("PlatformSet", typeof(ICommand), typeof(Elements), null,
            propertyChanged: OnPlatformSetChanged);

      public static ICommand GetPlatformSet(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(PlatformSetProperty);
   ...
   public static class Entries
   {
      ...
      public static readonly BindableProperty CompletedProperty =
         BindableProperty.CreateAttached("Completed", typeof(ICommand), typeof(Entries), null,
            propertyChanged: OnCompletedChanged);
      ...
      public static readonly BindableProperty TextChangedProperty =
         BindableProperty.CreateAttached("TextChanged", typeof(ICommand), typeof(Entries), null,
            propertyChanged: OnTextChangedChanged);
      ...
      public static readonly BindableProperty TextChangedNotifyNewTextValueProperty =
         BindableProperty.CreateAttached("TextChangedNotifyNewTextValue", typeof(ICommand), typeof(Entries), null,
            propertyChanged: OnTextChangedNotifyNewTextValueChanged);
      ...
      public static readonly BindableProperty TextChangedNotifyOldTextValueProperty =
         BindableProperty.CreateAttached("TextChangedNotifyOldTextValue", typeof(ICommand), typeof(Entries), null,
            propertyChanged: OnTextChangedNotifyOldTextValueChanged);
   ...
   public static class EntryCells
   {
      #region Completed

      public static readonly BindableProperty CompletedProperty =
         BindableProperty.CreateAttached("Completed", typeof(ICommand), typeof(EntryCells), null,
            propertyChanged: OnCompletedChanged);
   ...
   public static class ImageButtons
   {
      ...
      public static readonly BindableProperty ClickedProperty =
         BindableProperty.CreateAttached("Clicked", typeof(ICommand), typeof(ImageButtons), null,
            propertyChanged: OnClickedChanged);
      ...
      public static readonly BindableProperty PressedProperty =
         BindableProperty.CreateAttached("Pressed", typeof(ICommand), typeof(ImageButtons), null,
            propertyChanged: OnPressedChanged);
      ...
      public static readonly BindableProperty ReleasedProperty =
         BindableProperty.CreateAttached("Released", typeof(ICommand), typeof(ImageButtons), null,
            propertyChanged: OnReleasedChanged);
   ...
   public static class ItemsViews
   {
      #region ScrollToRequested

      public static readonly BindableProperty ScrollToRequestedProperty =
         BindableProperty.CreateAttached("ScrollToRequested", typeof(ICommand), typeof(ItemsViews), null,
            propertyChanged: OnScrollToRequestedChanged);

      public static ICommand GetScrollToRequested(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ScrollToRequestedProperty);
      ...
      public static readonly BindableProperty ScrollToRequestedNotifyIsAnimatedProperty =
         BindableProperty.CreateAttached("ScrollToRequestedNotifyIsAnimated", typeof(ICommand), typeof(ItemsViews),
            null, propertyChanged: OnScrollToRequestedNotifyIsAnimatedChanged);

      public static ICommand GetScrollToRequestedNotifyIsAnimated(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ScrollToRequestedNotifyIsAnimatedProperty);

      private static void OnScrollToRequestedNotifyIsAnimatedChanged(BindableObject bindable, object oldValue,
         object newValue)
      {
         if (bindable is ItemsView target)
         {
      ...
      private static void OnScrollToRequestedNotifyIsAnimated(object o, ScrollToRequestEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty ScrollToRequestedNotifyIndexProperty =
         BindableProperty.CreateAttached("ScrollToRequestedNotifyIndex", typeof(ICommand), typeof(ItemsViews), null,
            propertyChanged: OnScrollToRequestedNotifyIndexChanged);

      public static ICommand GetScrollToRequestedNotifyIndex(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ScrollToRequestedNotifyIndexProperty);

      private static void OnScrollToRequestedNotifyIndexChanged(BindableObject bindable, object oldValue,
         object newValue)
      {
         if (bindable is ItemsView target)
         {
      ...
      private static void OnScrollToRequestedNotifyIndex(object o, ScrollToRequestEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty ScrollToRequestedNotifyGroupIndexProperty =
         BindableProperty.CreateAttached("ScrollToRequestedNotifyGroupIndex", typeof(ICommand), typeof(ItemsViews),
            null, propertyChanged: OnScrollToRequestedNotifyGroupIndexChanged);

      public static ICommand GetScrollToRequestedNotifyGroupIndex(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ScrollToRequestedNotifyGroupIndexProperty);

      private static void OnScrollToRequestedNotifyGroupIndexChanged(BindableObject bindable, object oldValue,
         object newValue)
      {
         if (bindable is ItemsView target)
         {
      ...
      private static void OnScrollToRequestedNotifyGroupIndex(object o, ScrollToRequestEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty ScrollToRequestedNotifyItemProperty =
         BindableProperty.CreateAttached("ScrollToRequestedNotifyItem", typeof(ICommand), typeof(ItemsViews), null,
            propertyChanged: OnScrollToRequestedNotifyItemChanged);

      public static ICommand GetScrollToRequestedNotifyItem(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ScrollToRequestedNotifyItemProperty);

      private static void OnScrollToRequestedNotifyItemChanged(BindableObject bindable, object oldValue,
         object newValue)
      {
         if (bindable is ItemsView target)
         {
      ...
      private static void OnScrollToRequestedNotifyItem(object o, ScrollToRequestEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty ScrollToRequestedNotifyGroupProperty =
         BindableProperty.CreateAttached("ScrollToRequestedNotifyGroup", typeof(ICommand), typeof(ItemsViews), null,
            propertyChanged: OnScrollToRequestedNotifyGroupChanged);

      public static ICommand GetScrollToRequestedNotifyGroup(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ScrollToRequestedNotifyGroupProperty);

      private static void OnScrollToRequestedNotifyGroupChanged(BindableObject bindable, object oldValue,
         object newValue)
      {
         if (bindable is ItemsView target)
         {
      ...
      private static void OnScrollToRequestedNotifyGroup(object o, ScrollToRequestEventArgs eventArgs)
      {
   ...
   public static class Layouts
   {
      ...
      public static readonly BindableProperty LayoutChangedProperty =
         BindableProperty.CreateAttached("LayoutChanged", typeof(ICommand), typeof(Layouts), null,
            propertyChanged: OnLayoutChangedChanged);

      public static ICommand GetLayoutChanged(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(LayoutChangedProperty);
   ...
   public static partial class ListViews
   {
      ...
      public static readonly BindableProperty ItemAppearingProperty =
         BindableProperty.CreateAttached("ItemAppearing", typeof(ICommand), typeof(ListViews), null,
            propertyChanged: OnItemAppearingChanged);

      public static ICommand GetItemAppearing(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ItemAppearingProperty);
      ...
      public static readonly BindableProperty ItemAppearingNotifyItemProperty =
         BindableProperty.CreateAttached("ItemAppearingNotifyItem", typeof(ICommand), typeof(ListViews), null,
            propertyChanged: OnItemAppearingNotifyItemChanged);

      public static ICommand GetItemAppearingNotifyItem(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ItemAppearingNotifyItemProperty);
      ...
      private static void OnItemAppearingNotifyItem(object o, ItemVisibilityEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty ItemDisappearingProperty =
         BindableProperty.CreateAttached("ItemDisappearing", typeof(ICommand), typeof(ListViews), null,
            propertyChanged: OnItemDisappearingChanged);

      public static ICommand GetItemDisappearing(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ItemDisappearingProperty);
      ...
      public static readonly BindableProperty ItemDisappearingNotifyItemProperty =
         BindableProperty.CreateAttached("ItemDisappearingNotifyItem", typeof(ICommand), typeof(ListViews), null,
            propertyChanged: OnItemDisappearingNotifyItemChanged);

      public static ICommand GetItemDisappearingNotifyItem(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ItemDisappearingNotifyItemProperty);
      ...
      private static void OnItemDisappearingNotifyItem(object o, ItemVisibilityEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty ItemSelectedProperty =
         BindableProperty.CreateAttached("ItemSelected", typeof(ICommand), typeof(ListViews), null,
            propertyChanged: OnItemSelectedChanged);

      public static ICommand GetItemSelected(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ItemSelectedProperty);
      ...
      public static readonly BindableProperty ItemSelectedNotifySelectedItemProperty =
         BindableProperty.CreateAttached("ItemSelectedNotifySelectedItem", typeof(ICommand), typeof(ListViews), null,
            propertyChanged: OnItemSelectedNotifySelectedItemChanged);

      public static ICommand GetItemSelectedNotifySelectedItem(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ItemSelectedNotifySelectedItemProperty);

      private static void OnItemSelectedNotifySelectedItemChanged(BindableObject bindable, object oldValue,
         object newValue)
      {
         if (bindable is ListView target)
         {
      ...
      private static void OnItemSelectedNotifySelectedItem(object o, SelectedItemChangedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty ItemTappedProperty =
         BindableProperty.CreateAttached("ItemTapped", typeof(ICommand), typeof(ListViews), null,
            propertyChanged: OnItemTappedChanged);

      public static ICommand GetItemTapped(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ItemTappedProperty);
      ...
      public static readonly BindableProperty ItemTappedNotifyGroupProperty =
         BindableProperty.CreateAttached("ItemTappedNotifyGroup", typeof(ICommand), typeof(ListViews), null,
            propertyChanged: OnItemTappedNotifyGroupChanged);

      public static ICommand GetItemTappedNotifyGroup(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ItemTappedNotifyGroupProperty);
      ...
      private static void OnItemTappedNotifyGroup(object o, ItemTappedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty ItemTappedNotifyItemProperty =
         BindableProperty.CreateAttached("ItemTappedNotifyItem", typeof(ICommand), typeof(ListViews), null,
            propertyChanged: OnItemTappedNotifyItemChanged);

      public static ICommand GetItemTappedNotifyItem(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ItemTappedNotifyItemProperty);
      ...
      private static void OnItemTappedNotifyItem(object o, ItemTappedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty RefreshingProperty =
         BindableProperty.CreateAttached("Refreshing", typeof(ICommand), typeof(ListViews), null,
            propertyChanged: OnRefreshingChanged);

      public static ICommand GetRefreshing(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(RefreshingProperty);
      ...
      public static readonly BindableProperty ScrollToRequestedProperty =
         BindableProperty.CreateAttached("ScrollToRequested", typeof(ICommand), typeof(ListViews), null,
            propertyChanged: OnScrollToRequestedChanged);
      ...
      public static readonly BindableProperty ScrollToRequestedNotifyScrollXProperty =
         BindableProperty.CreateAttached("ScrollToRequestedNotifyScrollX", typeof(ICommand), typeof(ListViews), null,
            propertyChanged: OnScrollToRequestedNotifyScrollXChanged);

      public static ICommand GetScrollToRequestedNotifyScrollX(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ScrollToRequestedNotifyScrollXProperty);

      private static void OnScrollToRequestedNotifyScrollXChanged(BindableObject bindable, object oldValue,
         object newValue)
      {
         if (bindable is ListView target)
         {
      ...
      private static void OnScrollToRequestedNotifyScrollX(object o, ScrollToRequestedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty ScrollToRequestedNotifyScrollYProperty =
         BindableProperty.CreateAttached("ScrollToRequestedNotifyScrollY", typeof(ICommand), typeof(ListViews), null,
            propertyChanged: OnScrollToRequestedNotifyScrollYChanged);

      public static ICommand GetScrollToRequestedNotifyScrollY(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ScrollToRequestedNotifyScrollYProperty);

      private static void OnScrollToRequestedNotifyScrollYChanged(BindableObject bindable, object oldValue,
         object newValue)
      {
         if (bindable is ListView target)
         {
      ...
      private static void OnScrollToRequestedNotifyScrollY(object o, ScrollToRequestedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty ScrollToRequestedNotifyShouldAnimateProperty =
         BindableProperty.CreateAttached("ScrollToRequestedNotifyShouldAnimate", typeof(ICommand), typeof(ListViews),
            null, propertyChanged: OnScrollToRequestedNotifyShouldAnimateChanged);

      public static ICommand GetScrollToRequestedNotifyShouldAnimate(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ScrollToRequestedNotifyShouldAnimateProperty);

      private static void OnScrollToRequestedNotifyShouldAnimateChanged(BindableObject bindable, object oldValue,
         object newValue)
      {
         if (bindable is ListView target)
         {
      ...
      private static void OnScrollToRequestedNotifyShouldAnimate(object o, ScrollToRequestedEventArgs eventArgs)
      {
   ...
   public static class MasterDetailPages
   {
      #region BackButtonPressed

      public static readonly BindableProperty BackButtonPressedProperty =
         BindableProperty.CreateAttached("BackButtonPressed", typeof(ICommand), typeof(MasterDetailPages), null,
            propertyChanged: OnBackButtonPressedChanged);

      public static ICommand GetBackButtonPressed(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(BackButtonPressedProperty);
      ...
      public static readonly BindableProperty BackButtonPressedNotifyHandledProperty =
         BindableProperty.CreateAttached("BackButtonPressedNotifyHandled", typeof(ICommand), typeof(MasterDetailPages),
            null, propertyChanged: OnBackButtonPressedNotifyHandledChanged);

      public static ICommand GetBackButtonPressedNotifyHandled(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(BackButtonPressedNotifyHandledProperty);

      private static void OnBackButtonPressedNotifyHandledChanged(BindableObject bindable, object oldValue,
         object newValue)
      {
         if (bindable is MasterDetailPage target)
         {
      ...
      private static void OnBackButtonPressedNotifyHandled(object o, BackButtonPressedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty IsPresentedChangedProperty =
         BindableProperty.CreateAttached("IsPresentedChanged", typeof(ICommand), typeof(MasterDetailPages), null,
            propertyChanged: OnIsPresentedChangedChanged);

      public static ICommand GetIsPresentedChanged(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(IsPresentedChangedProperty);
   ...
   public static class MenuItems
   {
      ...
      public static readonly BindableProperty ClickedProperty =
         BindableProperty.CreateAttached("Clicked", typeof(ICommand), typeof(MenuItems), null,
            propertyChanged: OnClickedChanged);
   ...
   public static class NavigationPages
   {
      ...
      public static readonly BindableProperty InsertPageBeforeRequestedProperty =
         BindableProperty.CreateAttached("InsertPageBeforeRequested", typeof(ICommand), typeof(NavigationPages), null,
            propertyChanged: OnInsertPageBeforeRequestedChanged);

      public static ICommand GetInsertPageBeforeRequested(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(InsertPageBeforeRequestedProperty);
      ...
      public static readonly BindableProperty InsertPageBeforeRequestedNotifyAnimatedProperty =
         BindableProperty.CreateAttached("InsertPageBeforeRequestedNotifyAnimated", typeof(ICommand),
            typeof(NavigationPages), null, propertyChanged: OnInsertPageBeforeRequestedNotifyAnimatedChanged);

      public static ICommand GetInsertPageBeforeRequestedNotifyAnimated(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(InsertPageBeforeRequestedNotifyAnimatedProperty);

      private static void OnInsertPageBeforeRequestedNotifyAnimatedChanged(BindableObject bindable, object oldValue,
         object newValue)
      {
         if (bindable is NavigationPage target)
         {
      ...
      private static void OnInsertPageBeforeRequestedNotifyAnimated(object o, NavigationRequestedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty InsertPageBeforeRequestedNotifyTaskProperty =
         BindableProperty.CreateAttached("InsertPageBeforeRequestedNotifyTask", typeof(ICommand),
            typeof(NavigationPages), null, propertyChanged: OnInsertPageBeforeRequestedNotifyTaskChanged);

      public static ICommand GetInsertPageBeforeRequestedNotifyTask(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(InsertPageBeforeRequestedNotifyTaskProperty);

      private static void OnInsertPageBeforeRequestedNotifyTaskChanged(BindableObject bindable, object oldValue,
         object newValue)
      {
         if (bindable is NavigationPage target)
         {
      ...
      private static void OnInsertPageBeforeRequestedNotifyTask(object o, NavigationRequestedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty InsertPageBeforeRequestedNotifyRealizeProperty =
         BindableProperty.CreateAttached("InsertPageBeforeRequestedNotifyRealize", typeof(ICommand),
            typeof(NavigationPages), null, propertyChanged: OnInsertPageBeforeRequestedNotifyRealizeChanged);

      public static ICommand GetInsertPageBeforeRequestedNotifyRealize(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(InsertPageBeforeRequestedNotifyRealizeProperty);

      private static void OnInsertPageBeforeRequestedNotifyRealizeChanged(BindableObject bindable, object oldValue,
         object newValue)
      {
         if (bindable is NavigationPage target)
         {
      ...
      private static void OnInsertPageBeforeRequestedNotifyRealize(object o, NavigationRequestedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty PoppedProperty =
         BindableProperty.CreateAttached("Popped", typeof(ICommand), typeof(NavigationPages), null,
            propertyChanged: OnPoppedChanged);

      public static ICommand GetPopped(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(PoppedProperty);
      ...
      public static readonly BindableProperty PoppedToRootProperty =
         BindableProperty.CreateAttached("PoppedToRoot", typeof(ICommand), typeof(NavigationPages), null,
            propertyChanged: OnPoppedToRootChanged);

      public static ICommand GetPoppedToRoot(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(PoppedToRootProperty);
      ...
      public static readonly BindableProperty PopRequestedProperty =
         BindableProperty.CreateAttached("PopRequested", typeof(ICommand), typeof(NavigationPages), null,
            propertyChanged: OnPopRequestedChanged);

      public static ICommand GetPopRequested(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(PopRequestedProperty);
      ...
      public static readonly BindableProperty PopRequestedNotifyAnimatedProperty =
         BindableProperty.CreateAttached("PopRequestedNotifyAnimated", typeof(ICommand), typeof(NavigationPages), null,
            propertyChanged: OnPopRequestedNotifyAnimatedChanged);

      public static ICommand GetPopRequestedNotifyAnimated(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(PopRequestedNotifyAnimatedProperty);
      ...
      private static void OnPopRequestedNotifyAnimated(object o, NavigationRequestedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty PopRequestedNotifyTaskProperty =
         BindableProperty.CreateAttached("PopRequestedNotifyTask", typeof(ICommand), typeof(NavigationPages), null,
            propertyChanged: OnPopRequestedNotifyTaskChanged);

      public static ICommand GetPopRequestedNotifyTask(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(PopRequestedNotifyTaskProperty);
      ...
      private static void OnPopRequestedNotifyTask(object o, NavigationRequestedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty PopRequestedNotifyRealizeProperty =
         BindableProperty.CreateAttached("PopRequestedNotifyRealize", typeof(ICommand), typeof(NavigationPages), null,
            propertyChanged: OnPopRequestedNotifyRealizeChanged);

      public static ICommand GetPopRequestedNotifyRealize(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(PopRequestedNotifyRealizeProperty);
      ...
      private static void OnPopRequestedNotifyRealize(object o, NavigationRequestedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty PopToRootRequestedProperty =
         BindableProperty.CreateAttached("PopToRootRequested", typeof(ICommand), typeof(NavigationPages), null,
            propertyChanged: OnPopToRootRequestedChanged);

      public static ICommand GetPopToRootRequested(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(PopToRootRequestedProperty);
      ...
      public static readonly BindableProperty PopToRootRequestedNotifyAnimatedProperty =
         BindableProperty.CreateAttached("PopToRootRequestedNotifyAnimated", typeof(ICommand), typeof(NavigationPages),
            null, propertyChanged: OnPopToRootRequestedNotifyAnimatedChanged);

      public static ICommand GetPopToRootRequestedNotifyAnimated(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(PopToRootRequestedNotifyAnimatedProperty);

      private static void OnPopToRootRequestedNotifyAnimatedChanged(BindableObject bindable, object oldValue,
         object newValue)
      {
         if (bindable is NavigationPage target)
         {
      ...
      private static void OnPopToRootRequestedNotifyAnimated(object o, NavigationRequestedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty PopToRootRequestedNotifyTaskProperty =
         BindableProperty.CreateAttached("PopToRootRequestedNotifyTask", typeof(ICommand), typeof(NavigationPages),
            null, propertyChanged: OnPopToRootRequestedNotifyTaskChanged);

      public static ICommand GetPopToRootRequestedNotifyTask(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(PopToRootRequestedNotifyTaskProperty);

      private static void OnPopToRootRequestedNotifyTaskChanged(BindableObject bindable, object oldValue,
         object newValue)
      {
         if (bindable is NavigationPage target)
         {
      ...
      private static void OnPopToRootRequestedNotifyTask(object o, NavigationRequestedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty PopToRootRequestedNotifyRealizeProperty =
         BindableProperty.CreateAttached("PopToRootRequestedNotifyRealize", typeof(ICommand), typeof(NavigationPages),
            null, propertyChanged: OnPopToRootRequestedNotifyRealizeChanged);

      public static ICommand GetPopToRootRequestedNotifyRealize(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(PopToRootRequestedNotifyRealizeProperty);

      private static void OnPopToRootRequestedNotifyRealizeChanged(BindableObject bindable, object oldValue,
         object newValue)
      {
         if (bindable is NavigationPage target)
         {
      ...
      private static void OnPopToRootRequestedNotifyRealize(object o, NavigationRequestedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty PushedProperty =
         BindableProperty.CreateAttached("Pushed", typeof(ICommand), typeof(NavigationPages), null,
            propertyChanged: OnPushedChanged);

      public static ICommand GetPushed(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(PushedProperty);
      ...
      public static readonly BindableProperty PushRequestedProperty =
         BindableProperty.CreateAttached("PushRequested", typeof(ICommand), typeof(NavigationPages), null,
            propertyChanged: OnPushRequestedChanged);

      public static ICommand GetPushRequested(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(PushRequestedProperty);
      ...
      public static readonly BindableProperty PushRequestedNotifyAnimatedProperty =
         BindableProperty.CreateAttached("PushRequestedNotifyAnimated", typeof(ICommand), typeof(NavigationPages), null,
            propertyChanged: OnPushRequestedNotifyAnimatedChanged);

      public static ICommand GetPushRequestedNotifyAnimated(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(PushRequestedNotifyAnimatedProperty);

      private static void OnPushRequestedNotifyAnimatedChanged(BindableObject bindable, object oldValue,
         object newValue)
      {
         if (bindable is NavigationPage target)
         {
      ...
      private static void OnPushRequestedNotifyAnimated(object o, NavigationRequestedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty PushRequestedNotifyTaskProperty =
         BindableProperty.CreateAttached("PushRequestedNotifyTask", typeof(ICommand), typeof(NavigationPages), null,
            propertyChanged: OnPushRequestedNotifyTaskChanged);

      public static ICommand GetPushRequestedNotifyTask(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(PushRequestedNotifyTaskProperty);
      ...
      private static void OnPushRequestedNotifyTask(object o, NavigationRequestedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty PushRequestedNotifyRealizeProperty =
         BindableProperty.CreateAttached("PushRequestedNotifyRealize", typeof(ICommand), typeof(NavigationPages), null,
            propertyChanged: OnPushRequestedNotifyRealizeChanged);

      public static ICommand GetPushRequestedNotifyRealize(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(PushRequestedNotifyRealizeProperty);
      ...
      private static void OnPushRequestedNotifyRealize(object o, NavigationRequestedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty RemovePageRequestedProperty =
         BindableProperty.CreateAttached("RemovePageRequested", typeof(ICommand), typeof(NavigationPages), null,
            propertyChanged: OnRemovePageRequestedChanged);

      public static ICommand GetRemovePageRequested(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(RemovePageRequestedProperty);
      ...
      public static readonly BindableProperty RemovePageRequestedNotifyAnimatedProperty =
         BindableProperty.CreateAttached("RemovePageRequestedNotifyAnimated", typeof(ICommand), typeof(NavigationPages),
            null, propertyChanged: OnRemovePageRequestedNotifyAnimatedChanged);

      public static ICommand GetRemovePageRequestedNotifyAnimated(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(RemovePageRequestedNotifyAnimatedProperty);

      private static void OnRemovePageRequestedNotifyAnimatedChanged(BindableObject bindable, object oldValue,
         object newValue)
      {
         if (bindable is NavigationPage target)
         {
      ...
      private static void OnRemovePageRequestedNotifyAnimated(object o, NavigationRequestedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty RemovePageRequestedNotifyTaskProperty =
         BindableProperty.CreateAttached("RemovePageRequestedNotifyTask", typeof(ICommand), typeof(NavigationPages),
            null, propertyChanged: OnRemovePageRequestedNotifyTaskChanged);

      public static ICommand GetRemovePageRequestedNotifyTask(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(RemovePageRequestedNotifyTaskProperty);

      private static void OnRemovePageRequestedNotifyTaskChanged(BindableObject bindable, object oldValue,
         object newValue)
      {
         if (bindable is NavigationPage target)
         {
      ...
      private static void OnRemovePageRequestedNotifyTask(object o, NavigationRequestedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty RemovePageRequestedNotifyRealizeProperty =
         BindableProperty.CreateAttached("RemovePageRequestedNotifyRealize", typeof(ICommand), typeof(NavigationPages),
            null, propertyChanged: OnRemovePageRequestedNotifyRealizeChanged);

      public static ICommand GetRemovePageRequestedNotifyRealize(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(RemovePageRequestedNotifyRealizeProperty);

      private static void OnRemovePageRequestedNotifyRealizeChanged(BindableObject bindable, object oldValue,
         object newValue)
      {
         if (bindable is NavigationPage target)
         {
      ...
      private static void OnRemovePageRequestedNotifyRealize(object o, NavigationRequestedEventArgs eventArgs)
      {
   ...
   public static class OpenGLViews
   {
      #region DisplayRequested

      public static readonly BindableProperty DisplayRequestedProperty =
         BindableProperty.CreateAttached("DisplayRequested", typeof(ICommand), typeof(OpenGLViews), null,
            propertyChanged: OnDisplayRequestedChanged);

      public static ICommand GetDisplayRequested(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(DisplayRequestedProperty);
   ...
   public static class Pages
   {
      ...
      public static readonly BindableProperty AppearingProperty =
         BindableProperty.CreateAttached("Appearing", typeof(ICommand), typeof(Pages), null,
            propertyChanged: OnAppearingChanged);
      ...
      public static readonly BindableProperty DisappearingProperty =
         BindableProperty.CreateAttached("Disappearing", typeof(ICommand), typeof(Pages), null,
            propertyChanged: OnDisappearingChanged);
      ...
      public static readonly BindableProperty LayoutChangedProperty =
         BindableProperty.CreateAttached("LayoutChanged", typeof(ICommand), typeof(Pages), null,
            propertyChanged: OnLayoutChangedChanged);
   ...
   public static class PanGestureRecognizers
   {
      #region PanUpdated

      public static readonly BindableProperty PanUpdatedProperty =
         BindableProperty.CreateAttached("PanUpdated", typeof(ICommand), typeof(PanGestureRecognizers), null,
            propertyChanged: OnPanUpdatedChanged);

      public static ICommand GetPanUpdated(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(PanUpdatedProperty);
      ...
      public static readonly BindableProperty PanUpdatedNotifyGestureIdProperty =
         BindableProperty.CreateAttached("PanUpdatedNotifyGestureId", typeof(ICommand), typeof(PanGestureRecognizers),
            null, propertyChanged: OnPanUpdatedNotifyGestureIdChanged);

      public static ICommand GetPanUpdatedNotifyGestureId(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(PanUpdatedNotifyGestureIdProperty);
      ...
      private static void OnPanUpdatedNotifyGestureId(object o, PanUpdatedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty PanUpdatedNotifyTotalXProperty =
         BindableProperty.CreateAttached("PanUpdatedNotifyTotalX", typeof(ICommand), typeof(PanGestureRecognizers),
            null, propertyChanged: OnPanUpdatedNotifyTotalXChanged);

      public static ICommand GetPanUpdatedNotifyTotalX(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(PanUpdatedNotifyTotalXProperty);
      ...
      private static void OnPanUpdatedNotifyTotalX(object o, PanUpdatedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty PanUpdatedNotifyTotalYProperty =
         BindableProperty.CreateAttached("PanUpdatedNotifyTotalY", typeof(ICommand), typeof(PanGestureRecognizers),
            null, propertyChanged: OnPanUpdatedNotifyTotalYChanged);

      public static ICommand GetPanUpdatedNotifyTotalY(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(PanUpdatedNotifyTotalYProperty);
      ...
      private static void OnPanUpdatedNotifyTotalY(object o, PanUpdatedEventArgs eventArgs)
      {
   ...
   public static class Pickers
   {
      ...
      public static readonly BindableProperty SelectedIndexChangedProperty =
         BindableProperty.CreateAttached("SelectedIndexChanged", typeof(ICommand), typeof(Pickers), null,
            propertyChanged: OnSelectedIndexChangedChanged);

      public static ICommand GetSelectedIndexChanged(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(SelectedIndexChangedProperty);
   ...
   public static class PinchGestureRecognizers
   {
      #region PinchUpdated

      public static readonly BindableProperty PinchUpdatedProperty =
         BindableProperty.CreateAttached("PinchUpdated", typeof(ICommand), typeof(PinchGestureRecognizers), null,
            propertyChanged: OnPinchUpdatedChanged);

      public static ICommand GetPinchUpdated(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(PinchUpdatedProperty);
      ...
      public static readonly BindableProperty PinchUpdatedNotifyScaleProperty =
         BindableProperty.CreateAttached("PinchUpdatedNotifyScale", typeof(ICommand), typeof(PinchGestureRecognizers),
            null, propertyChanged: OnPinchUpdatedNotifyScaleChanged);

      public static ICommand GetPinchUpdatedNotifyScale(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(PinchUpdatedNotifyScaleProperty);
      ...
      private static void OnPinchUpdatedNotifyScale(object o, PinchGestureUpdatedEventArgs eventArgs)
      {
   ...
   public static class RowDefinitions
   {
      ...
      public static readonly BindableProperty SizeChangedProperty =
         BindableProperty.CreateAttached("SizeChanged", typeof(ICommand), typeof(RowDefinitions), null,
            propertyChanged: OnSizeChangedChanged);
   ...
   public static class ScrollViews
   {
      ...
      public static readonly BindableProperty ScrolledProperty =
         BindableProperty.CreateAttached("Scrolled", typeof(ICommand), typeof(ScrollViews), null,
            propertyChanged: OnScrolledChanged);

      public static ICommand GetScrolled(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ScrolledProperty);
      ...
      public static readonly BindableProperty ScrolledNotifyScrollXProperty =
         BindableProperty.CreateAttached("ScrolledNotifyScrollX", typeof(ICommand), typeof(ScrollViews), null,
            propertyChanged: OnScrolledNotifyScrollXChanged);

      public static ICommand GetScrolledNotifyScrollX(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ScrolledNotifyScrollXProperty);
      ...
      private static void OnScrolledNotifyScrollX(object o, ScrolledEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty ScrolledNotifyScrollYProperty =
         BindableProperty.CreateAttached("ScrolledNotifyScrollY", typeof(ICommand), typeof(ScrollViews), null,
            propertyChanged: OnScrolledNotifyScrollYChanged);

      public static ICommand GetScrolledNotifyScrollY(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ScrolledNotifyScrollYProperty);
      ...
      private static void OnScrolledNotifyScrollY(object o, ScrolledEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty ScrollToRequestedProperty =
         BindableProperty.CreateAttached("ScrollToRequested", typeof(ICommand), typeof(ScrollViews), null,
            propertyChanged: OnScrollToRequestedChanged);
      ...
      public static readonly BindableProperty ScrollToRequestedNotifyScrollXProperty =
         BindableProperty.CreateAttached("ScrollToRequestedNotifyScrollX", typeof(ICommand), typeof(ScrollViews), null,
            propertyChanged: OnScrollToRequestedNotifyScrollXChanged);
      ...
      public static readonly BindableProperty ScrollToRequestedNotifyScrollYProperty =
         BindableProperty.CreateAttached("ScrollToRequestedNotifyScrollY", typeof(ICommand), typeof(ScrollViews), null,
            propertyChanged: OnScrollToRequestedNotifyScrollYChanged);
      ...
      public static readonly BindableProperty ScrollToRequestedNotifyShouldAnimateProperty =
         BindableProperty.CreateAttached("ScrollToRequestedNotifyShouldAnimate", typeof(ICommand), typeof(ScrollViews),
            null, propertyChanged: OnScrollToRequestedNotifyShouldAnimateChanged);
   ...
   public static class SearchBars
   {
      #region SearchButtonPressed

      public static readonly BindableProperty SearchButtonPressedProperty =
         BindableProperty.CreateAttached("SearchButtonPressed", typeof(ICommand), typeof(SearchBars), null,
            propertyChanged: OnSearchButtonPressedChanged);

      public static ICommand GetSearchButtonPressed(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(SearchButtonPressedProperty);
      ...
      public static readonly BindableProperty TextChangedProperty =
         BindableProperty.CreateAttached("TextChanged", typeof(ICommand), typeof(SearchBars), null,
            propertyChanged: OnTextChangedChanged);
      ...
      public static readonly BindableProperty TextChangedNotifyNewTextValueProperty =
         BindableProperty.CreateAttached("TextChangedNotifyNewTextValue", typeof(ICommand), typeof(SearchBars), null,
            propertyChanged: OnTextChangedNotifyNewTextValueChanged);
      ...
      public static readonly BindableProperty TextChangedNotifyOldTextValueProperty =
         BindableProperty.CreateAttached("TextChangedNotifyOldTextValue", typeof(ICommand), typeof(SearchBars), null,
            propertyChanged: OnTextChangedNotifyOldTextValueChanged);
   ...
   public static class SelectableItemsViews
   {
      #region SelectionChanged

      public static readonly BindableProperty SelectionChangedProperty =
         BindableProperty.CreateAttached("SelectionChanged", typeof(ICommand), typeof(SelectableItemsViews), null,
            propertyChanged: OnSelectionChangedChanged);

      public static ICommand GetSelectionChanged(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(SelectionChangedProperty);
      ...
      public static readonly BindableProperty SelectionChangedNotifyPreviousSelectionProperty =
         BindableProperty.CreateAttached("SelectionChangedNotifyPreviousSelection", typeof(ICommand),
            typeof(SelectableItemsViews), null, propertyChanged: OnSelectionChangedNotifyPreviousSelectionChanged);

      public static ICommand GetSelectionChangedNotifyPreviousSelection(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(SelectionChangedNotifyPreviousSelectionProperty);

      private static void OnSelectionChangedNotifyPreviousSelectionChanged(BindableObject bindable, object oldValue,
         object newValue)
      {
         if (bindable is SelectableItemsView target)
         {
      ...
      private static void OnSelectionChangedNotifyPreviousSelection(object o, SelectionChangedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty SelectionChangedNotifyCurrentSelectionProperty =
         BindableProperty.CreateAttached("SelectionChangedNotifyCurrentSelection", typeof(ICommand),
            typeof(SelectableItemsViews), null, propertyChanged: OnSelectionChangedNotifyCurrentSelectionChanged);

      public static ICommand GetSelectionChangedNotifyCurrentSelection(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(SelectionChangedNotifyCurrentSelectionProperty);

      private static void OnSelectionChangedNotifyCurrentSelectionChanged(BindableObject bindable, object oldValue,
         object newValue)
      {
         if (bindable is SelectableItemsView target)
         {
      ...
      private static void OnSelectionChangedNotifyCurrentSelection(object o, SelectionChangedEventArgs eventArgs)
      {
   ...
   public static class Shells
   {
      ...
      public static readonly BindableProperty NavigatedProperty =
         BindableProperty.CreateAttached("Navigated", typeof(ICommand), typeof(Shells), null,
            propertyChanged: OnNavigatedChanged);

      public static ICommand GetNavigated(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(NavigatedProperty);
      ...
      public static readonly BindableProperty NavigatingProperty =
         BindableProperty.CreateAttached("Navigating", typeof(ICommand), typeof(Shells), null,
            propertyChanged: OnNavigatingChanged);

      public static ICommand GetNavigating(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(NavigatingProperty);
      ...
      public static readonly BindableProperty NavigatingNotifyCanCancelProperty =
         BindableProperty.CreateAttached("NavigatingNotifyCanCancel", typeof(ICommand), typeof(Shells), null,
            propertyChanged: OnNavigatingNotifyCanCancelChanged);

      public static ICommand GetNavigatingNotifyCanCancel(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(NavigatingNotifyCanCancelProperty);
      ...
      private static void OnNavigatingNotifyCanCancel(object o, ShellNavigatingEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty NavigatingNotifyCancelledProperty =
         BindableProperty.CreateAttached("NavigatingNotifyCancelled", typeof(ICommand), typeof(Shells), null,
            propertyChanged: OnNavigatingNotifyCancelledChanged);

      public static ICommand GetNavigatingNotifyCancelled(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(NavigatingNotifyCancelledProperty);
      ...
      private static void OnNavigatingNotifyCancelled(object o, ShellNavigatingEventArgs eventArgs)
      {
   ...
   public static class Sliders
   {
      ...
      public static readonly BindableProperty ValueChangedProperty =
         BindableProperty.CreateAttached("ValueChanged", typeof(ICommand), typeof(Sliders), null,
            propertyChanged: OnValueChangedChanged);

      public static ICommand GetValueChanged(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ValueChangedProperty);
      ...
      public static readonly BindableProperty ValueChangedNotifyNewValueProperty =
         BindableProperty.CreateAttached("ValueChangedNotifyNewValue", typeof(ICommand), typeof(Sliders), null,
            propertyChanged: OnValueChangedNotifyNewValueChanged);

      public static ICommand GetValueChangedNotifyNewValue(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ValueChangedNotifyNewValueProperty);
      ...
      private static void OnValueChangedNotifyNewValue(object o, ValueChangedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty ValueChangedNotifyOldValueProperty =
         BindableProperty.CreateAttached("ValueChangedNotifyOldValue", typeof(ICommand), typeof(Sliders), null,
            propertyChanged: OnValueChangedNotifyOldValueChanged);

      public static ICommand GetValueChangedNotifyOldValue(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ValueChangedNotifyOldValueProperty);
      ...
      private static void OnValueChangedNotifyOldValue(object o, ValueChangedEventArgs eventArgs)
      {
   ...
   public static class Steppers
   {
      ...
      public static readonly BindableProperty ValueChangedProperty =
         BindableProperty.CreateAttached("ValueChanged", typeof(ICommand), typeof(Steppers), null,
            propertyChanged: OnValueChangedChanged);
      ...
      public static readonly BindableProperty ValueChangedNotifyNewValueProperty =
         BindableProperty.CreateAttached("ValueChangedNotifyNewValue", typeof(ICommand), typeof(Steppers), null,
            propertyChanged: OnValueChangedNotifyNewValueChanged);
      ...
      public static readonly BindableProperty ValueChangedNotifyOldValueProperty =
         BindableProperty.CreateAttached("ValueChangedNotifyOldValue", typeof(ICommand), typeof(Steppers), null,
            propertyChanged: OnValueChangedNotifyOldValueChanged);
   ...
   public static class SwipeGestureRecognizers
   {
      #region Swiped

      public static readonly BindableProperty SwipedProperty =
         BindableProperty.CreateAttached("Swiped", typeof(ICommand), typeof(SwipeGestureRecognizers), null,
            propertyChanged: OnSwipedChanged);

      public static ICommand GetSwiped(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(SwipedProperty);
      ...
      public static readonly BindableProperty SwipedNotifyParameterProperty =
         BindableProperty.CreateAttached("SwipedNotifyParameter", typeof(ICommand), typeof(SwipeGestureRecognizers),
            null, propertyChanged: OnSwipedNotifyParameterChanged);

      public static ICommand GetSwipedNotifyParameter(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(SwipedNotifyParameterProperty);
      ...
      private static void OnSwipedNotifyParameter(object o, SwipedEventArgs eventArgs)
      {
   ...
   public static class Switchs
   {
      ...
      public static readonly BindableProperty ToggledProperty =
         BindableProperty.CreateAttached("Toggled", typeof(ICommand), typeof(Switchs), null,
            propertyChanged: OnToggledChanged);

      public static ICommand GetToggled(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ToggledProperty);
      ...
      public static readonly BindableProperty ToggledNotifyValueProperty =
         BindableProperty.CreateAttached("ToggledNotifyValue", typeof(ICommand), typeof(Switchs), null,
            propertyChanged: OnToggledNotifyValueChanged);

      public static ICommand GetToggledNotifyValue(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ToggledNotifyValueProperty);
      ...
      private static void OnToggledNotifyValue(object o, ToggledEventArgs eventArgs)
      {
   ...
   public static class SwitchCells
   {
      #region OnChanged

      public static readonly BindableProperty OnChangedProperty =
         BindableProperty.CreateAttached("OnChanged", typeof(ICommand), typeof(SwitchCells), null,
            propertyChanged: OnOnChangedChanged);

      public static ICommand GetOnChanged(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(OnChangedProperty);
      ...
      public static readonly BindableProperty OnChangedNotifyValueProperty =
         BindableProperty.CreateAttached("OnChangedNotifyValue", typeof(ICommand), typeof(SwitchCells), null,
            propertyChanged: OnOnChangedNotifyValueChanged);

      public static ICommand GetOnChangedNotifyValue(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(OnChangedNotifyValueProperty);
      ...
      private static void OnOnChangedNotifyValue(object o, ToggledEventArgs eventArgs)
      {
   ...
   public static class TableViews
   {
      ...
      public static readonly BindableProperty ModelChangedProperty =
         BindableProperty.CreateAttached("ModelChanged", typeof(ICommand), typeof(TableViews), null,
            propertyChanged: OnModelChangedChanged);

      public static ICommand GetModelChanged(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ModelChangedProperty);
   ...
   public static class TapGestureRecognizers
   {
      #region Tapped

      public static readonly BindableProperty TappedProperty =
         BindableProperty.CreateAttached("Tapped", typeof(ICommand), typeof(TapGestureRecognizers), null,
            propertyChanged: OnTappedChanged);
   ...
   public static class VisualElements
   {
      ...
      public static readonly BindableProperty BatchCommittedProperty =
         BindableProperty.CreateAttached("BatchCommitted", typeof(ICommand), typeof(VisualElements), null,
            propertyChanged: OnBatchCommittedChanged);

      public static ICommand GetBatchCommitted(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(BatchCommittedProperty);
      ...
      public static readonly BindableProperty ChildrenReorderedProperty =
         BindableProperty.CreateAttached("ChildrenReordered", typeof(ICommand), typeof(VisualElements), null,
            propertyChanged: OnChildrenReorderedChanged);

      public static ICommand GetChildrenReordered(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ChildrenReorderedProperty);
      ...
      public static readonly BindableProperty FocusChangeRequestedProperty =
         BindableProperty.CreateAttached("FocusChangeRequested", typeof(ICommand), typeof(VisualElements), null,
            propertyChanged: OnFocusChangeRequestedChanged);

      public static ICommand GetFocusChangeRequested(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(FocusChangeRequestedProperty);
      ...
      public static readonly BindableProperty FocusChangeRequestedNotifyFocusProperty =
         BindableProperty.CreateAttached("FocusChangeRequestedNotifyFocus", typeof(ICommand), typeof(VisualElements),
            null, propertyChanged: OnFocusChangeRequestedNotifyFocusChanged);

      public static ICommand GetFocusChangeRequestedNotifyFocus(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(FocusChangeRequestedNotifyFocusProperty);

      private static void OnFocusChangeRequestedNotifyFocusChanged(BindableObject bindable, object oldValue,
         object newValue)
      {
         if (bindable is VisualElement target)
         {
      ...
      private static void OnFocusChangeRequestedNotifyFocus(object o, VisualElement.FocusRequestArgs eventArgs)
      {
      ...
      public static readonly BindableProperty FocusChangeRequestedNotifyResultProperty =
         BindableProperty.CreateAttached("FocusChangeRequestedNotifyResult", typeof(ICommand), typeof(VisualElements),
            null, propertyChanged: OnFocusChangeRequestedNotifyResultChanged);

      public static ICommand GetFocusChangeRequestedNotifyResult(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(FocusChangeRequestedNotifyResultProperty);

      private static void OnFocusChangeRequestedNotifyResultChanged(BindableObject bindable, object oldValue,
         object newValue)
      {
         if (bindable is VisualElement target)
         {
      ...
      private static void OnFocusChangeRequestedNotifyResult(object o, VisualElement.FocusRequestArgs eventArgs)
      {
      ...
      public static readonly BindableProperty FocusedProperty =
         BindableProperty.CreateAttached("Focused", typeof(ICommand), typeof(VisualElements), null,
            propertyChanged: OnFocusedChanged);

      public static ICommand GetFocused(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(FocusedProperty);
      ...
      public static readonly BindableProperty FocusedNotifyIsFocusedProperty =
         BindableProperty.CreateAttached("FocusedNotifyIsFocused", typeof(ICommand), typeof(VisualElements), null,
            propertyChanged: OnFocusedNotifyIsFocusedChanged);

      public static ICommand GetFocusedNotifyIsFocused(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(FocusedNotifyIsFocusedProperty);
      ...
      private static void OnFocusedNotifyIsFocused(object o, FocusEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty MeasureInvalidatedProperty =
         BindableProperty.CreateAttached("MeasureInvalidated", typeof(ICommand), typeof(VisualElements), null,
            propertyChanged: OnMeasureInvalidatedChanged);

      public static ICommand GetMeasureInvalidated(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(MeasureInvalidatedProperty);
      ...
      public static readonly BindableProperty SizeChangedProperty =
         BindableProperty.CreateAttached("SizeChanged", typeof(ICommand), typeof(VisualElements), null,
            propertyChanged: OnSizeChangedChanged);
      ...
      public static readonly BindableProperty UnfocusedProperty =
         BindableProperty.CreateAttached("Unfocused", typeof(ICommand), typeof(VisualElements), null,
            propertyChanged: OnUnfocusedChanged);

      public static ICommand GetUnfocused(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(UnfocusedProperty);
      ...
      public static readonly BindableProperty UnfocusedNotifyIsFocusedProperty =
         BindableProperty.CreateAttached("UnfocusedNotifyIsFocused", typeof(ICommand), typeof(VisualElements), null,
            propertyChanged: OnUnfocusedNotifyIsFocusedChanged);

      public static ICommand GetUnfocusedNotifyIsFocused(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(UnfocusedNotifyIsFocusedProperty);
      ...
      private static void OnUnfocusedNotifyIsFocused(object o, FocusEventArgs eventArgs)
      {
   ...
   public static class WebViews
   {
      ...
      public static readonly BindableProperty EvalRequestedProperty =
         BindableProperty.CreateAttached("EvalRequested", typeof(ICommand), typeof(WebViews), null,
            propertyChanged: OnEvalRequestedChanged);

      public static ICommand GetEvalRequested(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(EvalRequestedProperty);
      ...
      public static readonly BindableProperty EvalRequestedNotifyScriptProperty =
         BindableProperty.CreateAttached("EvalRequestedNotifyScript", typeof(ICommand), typeof(WebViews), null,
            propertyChanged: OnEvalRequestedNotifyScriptChanged);

      public static ICommand GetEvalRequestedNotifyScript(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(EvalRequestedNotifyScriptProperty);
      ...
      private static void OnEvalRequestedNotifyScript(object o, EvalRequested eventArgs)
      {
      ...
      public static readonly BindableProperty GoBackRequestedProperty =
         BindableProperty.CreateAttached("GoBackRequested", typeof(ICommand), typeof(WebViews), null,
            propertyChanged: OnGoBackRequestedChanged);

      public static ICommand GetGoBackRequested(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(GoBackRequestedProperty);
      ...
      public static readonly BindableProperty GoForwardRequestedProperty =
         BindableProperty.CreateAttached("GoForwardRequested", typeof(ICommand), typeof(WebViews), null,
            propertyChanged: OnGoForwardRequestedChanged);

      public static ICommand GetGoForwardRequested(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(GoForwardRequestedProperty);
      ...
      public static readonly BindableProperty NavigatedProperty =
         BindableProperty.CreateAttached("Navigated", typeof(ICommand), typeof(WebViews), null,
            propertyChanged: OnNavigatedChanged);
      ...
      public static readonly BindableProperty NavigatedNotifyUrlProperty =
         BindableProperty.CreateAttached("NavigatedNotifyUrl", typeof(ICommand), typeof(WebViews), null,
            propertyChanged: OnNavigatedNotifyUrlChanged);

      public static ICommand GetNavigatedNotifyUrl(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(NavigatedNotifyUrlProperty);
      ...
      private static void OnNavigatedNotifyUrl(object o, WebNavigatedEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty NavigatingProperty =
         BindableProperty.CreateAttached("Navigating", typeof(ICommand), typeof(WebViews), null,
            propertyChanged: OnNavigatingChanged);
      ...
      public static readonly BindableProperty NavigatingNotifyCancelProperty =
         BindableProperty.CreateAttached("NavigatingNotifyCancel", typeof(ICommand), typeof(WebViews), null,
            propertyChanged: OnNavigatingNotifyCancelChanged);

      public static ICommand GetNavigatingNotifyCancel(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(NavigatingNotifyCancelProperty);
      ...
      private static void OnNavigatingNotifyCancel(object o, WebNavigatingEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty NavigatingNotifyUrlProperty =
         BindableProperty.CreateAttached("NavigatingNotifyUrl", typeof(ICommand), typeof(WebViews), null,
            propertyChanged: OnNavigatingNotifyUrlChanged);

      public static ICommand GetNavigatingNotifyUrl(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(NavigatingNotifyUrlProperty);
      ...
      private static void OnNavigatingNotifyUrl(object o, WebNavigatingEventArgs eventArgs)
      {
      ...
      public static readonly BindableProperty ReloadRequestedProperty =
         BindableProperty.CreateAttached("ReloadRequested", typeof(ICommand), typeof(WebViews), null,
            propertyChanged: OnReloadRequestedChanged);

      public static ICommand GetReloadRequested(BindableObject bindableObject) =>
         (ICommand) bindableObject.GetValue(ReloadRequestedProperty);
