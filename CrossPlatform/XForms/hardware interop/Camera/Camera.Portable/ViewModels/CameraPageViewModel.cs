...
namespace Camera.Portable.ViewModels
{
   ...
   public sealed class CameraPageViewModel : ViewModelBase
   {
      ...
      /// <summary>
      ///    Gets or sets a value indicating whether this <see cref="T:Camera.Portable.ViewModels.CameraPageViewModel" /> can
      ///    capture.
      /// </summary>
      ...
      /// <summary>
      ///    Gets or sets a value indicating whether this <see cref="T:Camera.Portable.ViewModels.CameraPageViewModel" /> camera
      ///    loading.
      /// </summary>
