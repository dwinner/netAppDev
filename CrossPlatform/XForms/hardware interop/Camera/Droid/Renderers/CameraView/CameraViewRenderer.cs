...
using Camera.Droid.Renderers.CameraView;
using Xamarin.Forms;
...
namespace Camera.Droid.Renderers.CameraView
{
   ...
   /// </summary>
   public class CameraViewRenderer : Xamarin.Forms.Platform.Android.AppCompat.ViewRenderer<Controls.CameraView, CameraDroid>
   {
      ...
      protected override void OnElementChanged(ElementChangedEventArgs<Controls.CameraView> e)
      {
