...
namespace Camera.Droid.Renderers
{
   ...
   public class FocusViewGestureDetector : GestureDetector.SimpleOnGestureListener
   {
      ...
      /// <param name="e">E.</param>
      public override bool OnDoubleTap(MotionEvent e) => base.OnDoubleTap(e);
      ...
      /// <param name="e">E.</param>
      public override bool OnDoubleTapEvent(MotionEvent e) => base.OnDoubleTapEvent(e);
      ...
      /// <param name="e">E.</param>
      public override bool OnSingleTapUp(MotionEvent e) => base.OnSingleTapUp(e);
      ...
      /// <param name="e">E.</param>
      public override bool OnSingleTapConfirmed(MotionEvent e) => base.OnSingleTapConfirmed(e);
