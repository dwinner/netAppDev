...
namespace Navigation.Pages
{
   ...
   {
      private readonly List<KeyValuePair<string, UIColor>> pageData;
      ...
      public DataViewController GetViewController(int index, UIStoryboard storyboard)
      {
         ...
         var dataViewController = (DataViewController) storyboard.InstantiateViewController(nameof(DataViewController));
         dataViewController.DataObject = pageData[index];

         return dataViewController;
      }

      public int IndexOf(DataViewController viewController) => pageData.IndexOf(viewController.DataObject);
