...
internal static class Program
{
   private static void Main()
   {
      ...
      using var pc1 = new PerformanceCounter("Processor",
         "% Processor Time",
         "_Total");
      Console.WriteLine(pc1.NextValue());

      var procName = Process.GetCurrentProcess().ProcessName;
      using var pc2 = new PerformanceCounter("Process",
         "Private Bytes",
         procName);
   ...
   private static void Monitor(string category, string counter, string instance,
