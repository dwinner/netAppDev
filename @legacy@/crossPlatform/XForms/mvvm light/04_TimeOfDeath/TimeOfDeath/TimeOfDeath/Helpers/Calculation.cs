...
namespace TimeOfDeath.Helpers
{
   ...
   {
      private double c, b, cas;
      private readonly CalcData calcData;
      private readonly double[,] correctionData = new double[3, 20];
      private readonly double[,] iterations = new double[3, 20];

      public Calculation(CalcData calc) => calcData = calc;
