...
[assembly: ExportRenderer(typeof(CustomImage),
   typeof(CustomImageRenderer))]
...
namespace Camera.Droid.Renderers
{
   ...
   /// </summary>
   public class CustomImageRenderer : Xamarin.Forms.Platform.Android.AppCompat.ViewRenderer<CustomImage, ImageView>
   {
      #region Constructors

      /// <summary>
      ///    Initializes a new instance of the <see cref="CustomImageRenderer" /> class.
      /// </summary>
      ...
      protected override void OnElementChanged(ElementChangedEventArgs<CustomImage> e)
      {
         ...
         if (e.NewElement != null)
         {
            ...
            Application.SynchronizationContext.Post(state => { UpdateControlColor(); }, null);
      ...
      private async Task LoadImage()
      {
         try
         {
            ...
            {
               Application.SynchronizationContext.Post(state => _imageView.SetImageBitmap(_bitmap), null);
            }
         }
      ...
      private void UpdateControlColor()
      {
         try
         {
            ...
            {
               var color = Color.ParseColor(_customImage.TintColorString.Replace(" ", ""));
