...
namespace Camera.Droid.Renderers.CameraView
{
   ...
   public class CameraDroid : FrameLayout, TextureView.ISurfaceTextureListener
   {
      ...
      /// </summary>
      private readonly CameraStateListener _stateListener;
      ...
      ///    The camera texture.
      /// </summary>
      private readonly AutoFitTextureView _cameraTexture;
      ...
      /// </summary>
      private readonly bool _mediaSoundLoaded;
      ...
      public void TakePhoto()
      {
         if (_context != null && _cameraDevice != null)
         {
            try
            {
               ...
               readerListener.Photo += (sender, e) => { Photo?.Invoke(this, e); };
      ...
      public void ChangeFocusPoint(Point e)
      {
         var cameraId = _manager.GetCameraIdList()[0];
         ...
         var viewWidth = _cameraTexture.Width;
         var viewHeight = _cameraTexture.Height;
         int ll, rr;
         ...
         var focusLeft = Clamp(ll, 0, right);
         var focusBottom = Clamp(rr, 0, bottom);

         newRect = new Rect(focusLeft, focusBottom, focusLeft + areaSize, focusBottom + areaSize);
         var meteringRectangle = new MeteringRectangle(newRect, 500);
      ...
      public void SwitchFlash(bool flashOn)
      {
         try
         {
            _previewBuilder.Set(CaptureRequest.FlashMode,
               new Integer(flashOn ? (int) FlashMode.Torch : (int) FlashMode.Off));
            UpdatePreview();
         }
         catch (System.Exception error)
         {
