...
namespace Camera.Pages
{
   ...
   public partial class CameraPage : ExtendedContentPage, INavigableXamarinFormsPage
   {
      ...
      /// </summary>
      private readonly float CAMERA_BUTTON_CONTAINER_WIDTH = 70f;

      /// <summary>
      ///    The model.
      /// </summary>
      private readonly CameraPageViewModel _model;
      ...
      public void OnNavigatedTo(IDictionary<string, object> navigationParameters)
      {
         ...
         LoadingView.SetBinding(IsVisibleProperty, new Binding("CameraLoading"));
      ...
      {
         FocusView.Orientation = CameraView.Orientation = PageOrientation = _model.PageOrientation = arg;
      ...
      public void HandleCameraAvailability(object sender, bool available)
      {
         ...
         if (available)
         {
            ...
            Device.BeginInvokeOnMainThread(() =>
            {
               ...
               PhotoEditLayout.SetBinding(IsVisibleProperty, new Binding("PhotoEditOn"));

               // camera button layouts
               CameraButtonContainerLandscape.SetBinding(OpacityProperty,
                  new Binding("PageOrientation", converter: new OrientationToDoubleConverter(),
                     converterParameter: "1, 1"));
               CameraButtonContainerLandscape.SetBinding(IsVisibleProperty,
                  new Binding("PageOrientation", converter: new OrientationToBoolConverter(),
                     converterParameter: "true, false"));
               CameraButtonContainerPortrait.SetBinding(OpacityProperty,
                  new Binding("PageOrientation", converter: new OrientationToDoubleConverter(),
                     converterParameter: "0, 1"));
               CameraButtonContainerPortrait.SetBinding(IsVisibleProperty,
                  new Binding("PageOrientation", converter: new OrientationToBoolConverter(),
