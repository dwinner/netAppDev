...
namespace StarWarsSample.Core.Services.Implementations
{
   public class PeopleService : IPeopleService
   {
      ...
      public PeopleService(IRestClient restClient) => _restClient = restClient;
      ...
      public Task<Person> GetPersonAsync() =>
         _restClient.MakeApiCall<Person>($"{Constants.BaseUrl}/people/1/", HttpMethod.Get);

/*
      private PagedResult<Person> GetMockedPeople() =>
         new PagedResult<Person>
         {
            Count = 3,
            Next = string.Empty,
