   ...
   public partial class RootViewController : UIViewController
   {
      ...
      public override void ViewDidLoad()
      {
         ...
         PageViewController.SetViewControllers(
            viewControllers, UIPageViewControllerNavigationDirection.Forward,
            false,
            null);
         ...
         {
            pageViewRect = new CGRect(pageViewRect.X + 20,
               pageViewRect.Y + 20,
               pageViewRect.Width - 40,
         ...
         UIInterfaceOrientation orientation)
      {
             ...
             UIDevice.CurrentDevice.UserInterfaceIdiom == UIUserInterfaceIdiom.Phone)
         {
            ...
            pageViewController.SetViewControllers(viewControllers, UIPageViewControllerNavigationDirection.Forward,
               true, null);
